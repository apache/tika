...
public class RecursiveMetadataFilterTest extends CXFTestBase {
    ...
    protected void setUpResources(JAXRSServerFactoryBean sf) {
        sf.setResourceClasses(RecursiveMetadataAndContentApiServiceImpl.class);
        sf.setResourceProvider(RecursiveMetadataAndContentApiServiceImpl.class,
                new SingletonResourceProvider(new RecursiveMetadataAndContentApiServiceImpl()));
    }
