...
public class TikaWelcomeTest extends CXFTestBase {
	...
	rpsCore.add(new SingletonResourceProvider(new DetectorResourceApiServiceImpl(new ServerStatus())));
	rpsCore.add(new SingletonResourceProvider(new MetadataResourceApiServiceImpl()));
