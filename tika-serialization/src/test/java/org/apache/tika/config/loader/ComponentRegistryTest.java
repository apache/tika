...
public class ComponentRegistryTest {
    ...
    @Test
    public void testAutoGeneratedKebabCaseName() throws Exception {
        ComponentRegistry registry = new ComponentRegistry("parsers",
                getClass().getClassLoader());

        // Verify that AutoNamedTestParser is registered with auto-generated kebab-case name
        assertTrue(registry.hasComponent("auto-named-test-parser"),
                "Should have auto-named-test-parser");

        Class<?> clazz = registry.getComponentClass("auto-named-test-parser");
        assertNotNull(clazz, "Component class should not be null");
        assertEquals("org.apache.tika.config.loader.AutoNamedTestParser",
                clazz.getName(),
                "AutoNamedTestParser should be mapped to kebab-case name 'auto-named-test-parser'");
    }
}
