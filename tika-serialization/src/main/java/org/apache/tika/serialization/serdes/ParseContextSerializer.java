 ...
 * <p>
 * Serializes the jsonConfigs map directly - each entry becomes a field in the output.
 * The resolvedConfigs cache is intentionally ignored to preserve round-trip fidelity.
 * <p>
 * Example output:
 * <pre>
 * {
...
public class ParseContextSerializer extends JsonSerializer<ParseContext> {
    ...
    public void serialize(ParseContext parseContext, JsonGenerator gen,
        ...
        // Serialize all JSON configs - this is the source of truth for round-trip
