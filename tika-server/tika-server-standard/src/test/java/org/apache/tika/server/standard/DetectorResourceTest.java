...
public class DetectorResourceTest extends CXFTestBase {
    ...
    protected void setUpResources(JAXRSServerFactoryBean sf) {
        ...
        sf.setResourceProvider(DetectorResource.class, new SingletonResourceProvider(
    ...
    public void testDetectCsvWithExt() throws Exception {
        ...
        Response response = WebClient.create(endPoint + DETECT_STREAM_PATH).type("text/csv")
                        .accept("*/*")
