...
public class TikaEvalResource implements TikaServerResource, ServerStatusResource {
    ...
    public static final Property DICE =
                    Property.externalReal(TikaEvalMetadataFilter.TIKA_EVAL_NS + "dice");

    public static final Property OVERLAP =
                    Property.externalReal(TikaEvalMetadataFilter.TIKA_EVAL_NS + "overlap");
    ...
    private Map<String, Object> compareText(String id, String textA, String textB,
                    long timeoutMillis) {
