...
public class ProduceTypeResourceComparator implements ResourceComparator {
     ...
     */
    public static final List<MediaType> PRIORITIZED_MEDIA_LIST = Arrays.asList(MediaType.TEXT_PLAIN_TYPE,
            MediaType.APPLICATION_JSON_TYPE, MediaType.TEXT_HTML_TYPE, MediaType.TEXT_XML_TYPE);
    /**
     * The logger
     */
    ...
    public int compare(OperationResourceInfo oper1, OperationResourceInfo oper2, Message message) {
        ...
        LOG.debug("Message Method : " + httpMethod + ", ContentType : " + contentType + ", " + "Accept Types : "
                + acceptTypes);
