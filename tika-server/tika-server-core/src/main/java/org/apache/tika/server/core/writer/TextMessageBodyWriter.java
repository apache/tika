...
/**
 * Returns simple text string for a particular metadata value. This assumes that the metadata object
 * only has one key; if there is more than one key or no keys, this will throw a webapp exception.
 * <p/>
