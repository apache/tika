...
/**
 * This class looks for &quot;fetcherName&quot; in the http header. If it is not null and not empty,
 * this will return a new TikaInputStream from the fetch key and the base path as set in the
 * definition of the named fetcher. As of Tika &gt; 2.5.0, the &quot;fetchKey&quot; is URL decoded.
 * <p>
 * Users may also specify the &quot;fetcherName&quote; and &quot;fetchKey&quot; in query parameters
 * with in the request.
 * <p>
 * <em>WARNING:</em> Unless you carefully lock down access to the server, whoever has access to this
 * service will have the read access of the server. In short, anyone with access to this service
 * could request and get &quot;file:///etc/supersensitive_file_dont_read.txt&quot;. Or, if your
 * server has access to your intranet, and you let the public hit this service, they will now have
 * access to your intranet. See
 * <a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2015-3271">CVE-2015-3271</a>
 */
public class FetcherStreamFactory implements InputStreamFactory {
    ...
    /**
     * Tries to parse a long out of the value. If the val is blank, it returns -1. Throws
        ...
        if (!StringUtils.isBlank(fetcherName)) {
            try {
                ...
                if (fetchRangeStart > -1 && fetchRangeEnd > -1
                                && !(fetcher instanceof RangeFetcher)) {
                    throw new IllegalArgumentException(
                                    "Can't call a fetch with a range on a fetcher that"
                                                    + " is not a RangeFetcher: name="
                                                    + fetcher.getName() + " class="
                                                    + fetcher.getClass());
                }
