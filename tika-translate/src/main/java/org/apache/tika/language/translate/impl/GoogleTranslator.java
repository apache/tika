...
/**
 * An implementation of a REST client to the
 * <a href="https://www.googleapis.com/language/translate/v2">Google Translate v2 API</a>. Based on
 * the <a href="http://hayageek.com/google-translate-api-tutorial/">great tutorial</a> from
 * <a href="http://hayageek.com">hayageek.com</a>. Set your API key in translator.google.properties.
 */
public class GoogleTranslator extends AbstractTranslator {
    ...
    public String translate(String text, String sourceLanguage, String targetLanguage)
        ...
        Response response = client.accept(MediaType.APPLICATION_JSON).query("key", apiKey)
                        .query("source", sourceLanguage).query("target", targetLanguage)
                        .query("q", text).get();
