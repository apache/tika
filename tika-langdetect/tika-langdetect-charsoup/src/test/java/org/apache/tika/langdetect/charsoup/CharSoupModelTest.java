...
public class CharSoupModelTest {
    ...
    public void testRoundTrip() throws IOException {
        ...
        CharSoupModel original = new CharSoupModel(numBuckets, numClasses, labels, scales, biases,
                weights);
        ...
        CharSoupModel loaded = CharSoupModel.load(new ByteArrayInputStream(bytes));
    ...
    public void testSoftmax() {
        ...
        float[] probs = CharSoupModel.softmax(logits);
    ...
    public void testPredict() {
        ...
        CharSoupModel model = new CharSoupModel(numBuckets, numClasses, labels, scales, biases,
                weights);
    ...
    public void testCorruptMagicThrows() {
        ...
        assertThrows(IOException.class,
                () -> CharSoupModel.load(new ByteArrayInputStream(baos.toByteArray())));
    }

    @Test
    public void testSaveHeaderFormat() throws IOException {
        CharSoupModel model = new CharSoupModel(128, 2, new String[]{"a", "b"},
