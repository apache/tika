...
public class ProfilingWriter extends Writer {
    ...
    /**
     * Returns the language profile being built by this writer. Note that the returned profile gets
     * updated whenever new characters are written. Use the {@link #getLanguage()} method to get the
     * language that best matches the current state of the profile.
     *
