    ...
    void registeredFormatTransformerReplacesFallbackAndKeepsTailLossless() {
        DocumentTransformer testFormat = new DocumentTransformer() {
            ...
            public boolean appliesTo(Metadata tika) {
                return "application/x-test".equals(tika.get(HttpHeaders.CONTENT_TYPE));
            }
        ...
        Metadata metadata = new Metadata();
        metadata.set(HttpHeaders.CONTENT_TYPE, "application/x-test");
        ...
        other.set(HttpHeaders.CONTENT_TYPE, "text/plain");
