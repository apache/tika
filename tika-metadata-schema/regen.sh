...
# multi-step manual sequence in .skills/dev/metadata-schema/SKILL.md with one command:
...
#
# See tika-metadata-schema/README.md and .skills/dev/metadata-schema/SKILL.md for the
...
echo "==> Regenerating the registry (forked exec — see .skills/dev/metadata-schema/SKILL.md for why exec:java is unsafe)"
