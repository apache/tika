...
public class ExtractReaderException extends IOException {
    ...
    public enum TYPE {
        ...
        NO_EXTRACT_FILE, ZERO_BYTE_EXTRACT_FILE, IO_EXCEPTION, EXTRACT_PARSE_EXCEPTION, EXTRACT_FILE_TOO_SHORT,
        EXTRACT_FILE_TOO_LONG, INCORRECT_EXTRACT_FILE_SUFFIX//extract file must have suffix of .json or .txt,
