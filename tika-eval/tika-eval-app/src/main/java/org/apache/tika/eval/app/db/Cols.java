...
public enum Cols {
    ...
    //content
    CONTENT_LENGTH, NUM_REPLACEMENT, NUM_NON_ASCII, //U+FFFD + non-ASCII (>=0x80) counts; FFFD rate via SQL: num_replacement/num_non_ascii

    NUM_UNIQUE_TOKENS, NUM_TOKENS, NUM_UNIQUE_ALPHABETIC_TOKENS, NUM_ALPHABETIC_TOKENS, //alphabetic or ideographic tokens
