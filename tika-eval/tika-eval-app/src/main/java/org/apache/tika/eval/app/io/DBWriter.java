...
/**
 * This is still in its early stages. The idea is to get something working with h2 and then add to
 * that as necessary.
 * <p>
 * Beware, this deletes the db file with each initialization.
 * <p>
 * Each thread must construct its own DBWriter because each DBWriter creates its own
 * PreparedStatements at initialization.
 */
public class DBWriter implements IDBWriter {
    ...
    /**
     * This closes the writer by executing batch and committing changes. This DOES NOT close the
     * connection
     *
     * @throws IOException
     */
