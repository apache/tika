...
/**
 * Creates a very narrowly focused TokenFilter that limits tokens based on length _unless_ they've
 * been identified as &lt;DOUBLE&gt; or &lt;SINGLE&gt; by the CJKBigramFilter.
 * <p>
...
public class CJKBigramAwareLengthFilterFactory extends TokenFilterFactory {
    ...
    /*
     * private static boolean isCJ(int codePoint) { if ( (codePoint >= 0x4E00 && codePoint <=
     * 0x9FFF) || ( codePoint >= 0x3400 && codePoint <= 0x4dbf) || ( codePoint >= 0x20000 &&
     * codePoint <= 0x2a6df) || ( codePoint >= 0x2A700 && codePoint <= 0x2b73f) || ( codePoint >=
     * 0x2B740 && codePoint <= 0x2B81F) || ( codePoint >= 0x2B820 && codePoint <- 0x2CEAF) || (
     * codePoint >= 0xF900 && codePoint <= 0xFAFF) || ( codePoint >= 0x2F800 && codePoint <=
