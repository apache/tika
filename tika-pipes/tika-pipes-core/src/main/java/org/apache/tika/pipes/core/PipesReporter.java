 ...
 * way.
 * <p/>
 * Note, however, that this is not called in the forked processes. Implementers do not have to worry
 * about synchronizing across processes; for example, one could use an in-memory h2 database as a
 * target.
 */
public abstract class PipesReporter implements Closeable {
    ...
    /**
     * No-op implementation. Override for custom behavior and make sure to override
     * {@link #supportsTotalCount()} to return <code>true</code>
     * 
