...
public class PipesResult {
    ...
    public enum STATUS {
        CLIENT_UNAVAILABLE_WITHIN_MS, FETCHER_INITIALIZATION_EXCEPTION, FETCH_EXCEPTION, EMPTY_OUTPUT, PARSE_EXCEPTION_NO_EMIT, // within
                                                                                                                                // the
                                                                                                                                // pipes
                                                                                                                                // server
        ...
        OOM, TIMEOUT, UNSPECIFIED_CRASH, NO_EMITTER_FOUND, EMIT_SUCCESS, EMIT_SUCCESS_PARSE_EXCEPTION, EMIT_EXCEPTION, EMIT_SUCCESS_PASSBACK, // emit
                                                                                                                                              // happened
                                                                                                                                              // and
                                                                                                                                              // some
                                                                                                                                              // data
