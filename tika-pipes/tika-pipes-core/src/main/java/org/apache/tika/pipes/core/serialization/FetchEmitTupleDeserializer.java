...
public class FetchEmitTupleDeserializer extends JsonDeserializer<FetchEmitTuple> {
    ...
    public FetchEmitTuple deserialize(JsonParser jsonParser,
        ...
        return new FetchEmitTuple(id,
                        new FetchKey(fetcherName, fetchKey, fetchRangeStart, fetchRangeEnd),
                        new EmitKey(emitterName, emitKey), metadata, parseContext,
                        onParseException);
    }

    private static FetchEmitTuple.ON_PARSE_EXCEPTION readOnParseException(JsonNode root)
                    throws IOException {
    ...
    private static String readVal(String key, JsonNode jsonObj, String defaultRet,
    ...
    private static long readLong(String key, JsonNode jsonObj, long defaultVal, boolean isRequired)
                    throws IOException {
