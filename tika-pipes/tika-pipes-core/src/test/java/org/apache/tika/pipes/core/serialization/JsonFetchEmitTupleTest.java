...
public class JsonFetchEmitTupleTest {
    ...
    public void testBasic() throws Exception {
        ...
        HandlerConfig h = new HandlerConfig(BasicContentHandlerFactory.HANDLER_TYPE.XML,
                        HandlerConfig.PARSE_MODE.CONCATENATE, 10000, 10, true);
    ...
    public void testFetchRange() throws Exception {
        ...
        /**
         * TODO -- add this to the ParseContext new
    ...
    public void testBytes() throws Exception {
        /**
         * TODO -- add these to the ParseContext EmbeddedDocumentBytesConfig bytesConfig = new
         * EmbeddedDocumentBytesConfig(true); bytesConfig.setEmitter("emitter"); new
         * HandlerConfig(BasicContentHandlerFactory.HANDLER_TYPE.XML,
         * HandlerConfig.PARSE_MODE.CONCATENATE, 10000,10, true)
         */
        FetchEmitTuple t = new FetchEmitTuple("my_id",
                        new FetchKey("my_fetcher", "fetchKey1", 10, 1000),
                        new EmitKey("my_emitter", "emitKey1"), new Metadata(), new ParseContext(),
                        FetchEmitTuple.ON_PARSE_EXCEPTION.SKIP);
        StringWriter writer = new StringWriter();
        JsonFetchEmitTuple.toJson(t, writer);
        Reader reader = new StringReader(writer.toString());
