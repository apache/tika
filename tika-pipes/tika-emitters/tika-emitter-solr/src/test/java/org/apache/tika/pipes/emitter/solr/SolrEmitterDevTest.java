...
/**
 * This is meant only for one off development tests with a locally running instance of Solr. Please
 * add unit tests to the tika-integration-tests/tika-pipes-solr-integration-tests
 */
@Disabled
