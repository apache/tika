...
public class OpenSearchEmitter extends AbstractEmitter implements Initializable {
    ...
    /**
     * Options: SEPARATE_DOCUMENTS, PARENT_CHILD. Default is "SEPARATE_DOCUMENTS". All embedded
     * documents are treated as independent documents. PARENT_CHILD requires a schema to be set up
     * for the relationship type; all embedded objects (no matter how deeply nested) will have a
     * single parent of the main container document.
     *
     * If you want to concatenate the content of embedded files and ignore the metadata of embedded
     * files, set {@link org.apache.tika.pipes.HandlerConfig}'s parseMode to
     * {@link org.apache.tika.pipes.HandlerConfig.PARSE_MODE#CONCATENATE} in your
     * {@link org.apache.tika.pipes.FetchEmitTuple} or in the &lt;parseMode&gt; element in your
     * {@link org.apache.tika.pipes.pipesiterator.PipesIterator} configuration.
     */
    @Field
    ...
    public void initialize(Map<String, Param> params) throws TikaConfigException {
        if (StringUtils.isBlank(openSearchUrl)) {
            ...
            openSearchClient = new OpenSearchClient(openSearchUrl, httpClientFactory.build(),
                            attachmentStrategy, updateStrategy, embeddedFileFieldName);
        }
    }
