...
public class GCSPipesIteratorConfig implements PipesIteratorConfig {
    ...
    public static GCSPipesIteratorConfig load(JsonNode jsonNode) throws IOException, TikaConfigException {
        try {
            return OBJECT_MAPPER.treeToValue(jsonNode, GCSPipesIteratorConfig.class);
