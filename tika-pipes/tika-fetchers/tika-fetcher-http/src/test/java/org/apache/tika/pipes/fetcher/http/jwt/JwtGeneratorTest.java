...
class JwtGeneratorTest {
    ...
    void jwtSecret() throws Exception {
        ...
        String jwt = new JwtGenerator(new JwtSecretCreds(randomBytes, "nick", "subject", 120))
                        .jwt();
    ...
    void jwtPrivateKey() throws Exception {
        ...
        String jwt = new JwtGenerator(
                        new JwtPrivateKeyCreds(keyPair.getPrivate(), "nick", "subject", 120)).jwt();
