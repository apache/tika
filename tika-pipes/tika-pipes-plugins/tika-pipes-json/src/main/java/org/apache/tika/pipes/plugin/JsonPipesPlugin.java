...
public class JsonPipesPlugin extends Plugin {
    private static final Logger LOG = LoggerFactory.getLogger(JsonPipesPlugin.class);

    public JsonPipesPlugin(PluginWrapper wrapper) {
        super(wrapper);
    }
