 ...
 */
package org.apache.tika.module.vorbis;
...
public class BundleIT {
    ...
    public void testBundleLoaded() throws Exception {
        ...
        for (Bundle b : bc.getBundles()) {
            ...
            if ("org.apache.tika.parser-vorbis-bundle".equals(b.getSymbolicName())) {
                hasBundle = true;
    ...
    public void testServicesCreated() throws Exception {
        ...
        assertEquals("Not all Services have started", 6, services.length);
    }
}
