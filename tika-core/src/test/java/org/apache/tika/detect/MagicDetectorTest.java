...
public class MagicDetectorTest {
    ...
    public void testDetectRegExPDF() throws Exception {
        ...
        assertDetect(detector, pdf,
                "0        10        20        30        40        50        6"
                        + "0        70        80        90        100       110       1" + "20       130       140"
                        + "34%PDF-1.0");
        assertDetect(detector, MediaType.OCTET_STREAM,
                "0        10        20        30        40        50        6"
                        + "0        70        80        90        100       110       1" + "20       130       140"
    ...
    public void testDetectRegExGreedy() throws Exception {
        ...
        assertDetect(detector, xhtml,
                "<html xmlns=\"http://www.w3.org/1999/xhtml\">" + "<head><title>XHTML test document</title></head>");
    }
    ...
    public void testDetectRegExOptions() throws Exception {
        ...
        String data = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01//EN\""
                + "\"http://www.w3.org/TR/html4/strict.dtd\"><HTML>" + "<HEAD><TITLE>HTML document</TITLE></HEAD>"
    ...
    public void testBZ2Detection() throws Exception {
        ...
        for (String bz2 : new String[]{"bzip2-8-file.txt.bz2", "empty-file.txt.bz2", "lbzip2-8-file.txt.bz2",
                "small-file.txt.bz2", "test-file-1.csv.bz2", "test-file-2.csv.bz2"}) {
