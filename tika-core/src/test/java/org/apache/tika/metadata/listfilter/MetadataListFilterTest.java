...
public class MetadataListFilterTest {
    ...
    public void testBasic() throws Exception {
        ...
        try (InputStream is = MetadataListFilterTest.class
                        .getResourceAsStream("metadatalistfilter-config.xml")) {
        ...
        assertTrue(compositeMetadataListFilter.getFilters()
                        .get(0) instanceof AttachmentCountingListFilter);
    }
}
