...
public class ProbabilisticMimeDetectionTest {
    ...
    public void testByteOrderMark() throws Exception {
        assertEquals(MediaType.TEXT_PLAIN,
                proDetector.detect(new ByteArrayInputStream("\ufefftest".getBytes(UTF_16LE)), new Metadata()));
        assertEquals(MediaType.TEXT_PLAIN,
                proDetector.detect(new ByteArrayInputStream("\ufefftest".getBytes(UTF_16BE)), new Metadata()));

        assertEquals(MediaType.TEXT_PLAIN,
                proDetector.detect(new ByteArrayInputStream("\ufefftest".getBytes(UTF_8)), new Metadata()));
    }
