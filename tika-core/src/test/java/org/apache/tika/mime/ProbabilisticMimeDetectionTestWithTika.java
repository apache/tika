...
public class ProbabilisticMimeDetectionTestWithTika {
    ...
    public void setUp() {
        ...
        /*
         * here is an example with the use of the builder to instantiate the object.
         */
        Builder builder = new ProbabilisticMimeDetectionSelector.Builder();
        proSelector = new ProbabilisticMimeDetectionSelector(types, builder.priorMagicFileType(0.5f)
                        .priorExtensionFileType(0.5f).priorMetaFileType(0.5f));
    ...
    private void testStream(String expected, String urlOrFileName, InputStream in)
        ...
        try {
            ...
            assertEquals(expected, mime, urlOrFileName
