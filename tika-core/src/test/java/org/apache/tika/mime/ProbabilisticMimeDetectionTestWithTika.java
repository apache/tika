...
public class ProbabilisticMimeDetectionTestWithTika {
    ...
    public void testByteOrderMark() throws Exception {
        assertEquals(MediaType.TEXT_PLAIN.toString(),
                tika.detect(TikaInputStream.get("\ufefftest".getBytes(UTF_16LE)),
                        new Metadata()));
        assertEquals(MediaType.TEXT_PLAIN.toString(),
                tika.detect(TikaInputStream.get("\ufefftest".getBytes(UTF_16BE)),
                        new Metadata()));

        assertEquals(MediaType.TEXT_PLAIN.toString(),
                tika.detect(TikaInputStream.get("\ufefftest".getBytes(UTF_8)),
                        new Metadata()));
    }
    ...
    public void testMimeMagicClashSamePriority() throws IOException {
        ...
        assertEquals(helloType.toString(),
                tika.detect(TikaInputStream.get(helloWorld), metadata));
