 ...
 *
 * @see <a href=
 *      "http://www.iso.org/iso/iso_catalogue/catalogue_tc/catalogue_detail.htm?csnumber=59575" >ISO
...
public interface OfficeOpenXMLExtended {
    ...
    Property COMMENTS = Property.externalTextBag(WORD_PROCESSING_PREFIX
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "Comments");
}
