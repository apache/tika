...
/**
 * Metadata keys for the XMP DublinCore schema. This differs from {@link DublinCore} in that this
 * data must derive strictly from XMP. Tika applies logic to normalize metadata keys and values into
 * {@link DublinCore}. This process can make it difficult to determine if the underlying metadata
 * derived from a literal XMP component or from another source within the file.
 * <p>
