 ...
 * <p>
 * A collection of property constants for the Photo Metadata properties defined in the XMP Photoshop
 * standard.
 *
...
public interface Photoshop {
    ...
    Property AUTHORS_POSITION = Property.internalText(PREFIX_PHOTOSHOP
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "AuthorsPosition");

    // TODO Replace this with proper indexed choices support
    String[] _COLOR_MODE_CHOICES_INDEXED = {"Bitmap", "Greyscale", "Indexed Colour", "RGB Color",
                    "CMYK Colour", "Multi-Channel", "Duotone", "LAB Colour", "reserved", "reserved",
                    "YCbCr Colour", "YCgCo Colour", "YCbCrK Colour"};
    ...
    Property CAPTION_WRITER = Property.internalText(PREFIX_PHOTOSHOP
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "CaptionWriter");
    ...
    Property DATE_CREATED = Property.internalDate(PREFIX_PHOTOSHOP
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "DateCreated");

    Property HEADLINE = Property.internalText(
                    PREFIX_PHOTOSHOP + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "Headline");

    Property INSTRUCTIONS = Property.internalText(PREFIX_PHOTOSHOP
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "Instructions");
    ...
    Property SUPPLEMENTAL_CATEGORIES = Property.internalTextBag(PREFIX_PHOTOSHOP
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "SupplementalCategories");

    Property TRANSMISSION_REFERENCE = Property.internalText(PREFIX_PHOTOSHOP
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "TransmissionReference");
