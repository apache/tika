...
/**
 * XMP property definition violation exception. This is thrown when you try to set a
 * {@link Property} value with an incorrect type, such as storing an Integer when the property is of
 * type Date.
 *
