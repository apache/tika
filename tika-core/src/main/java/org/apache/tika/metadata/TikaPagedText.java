...
public interface TikaPagedText {
     ...
     */
    Property PAGE_NUMBER = Property.reservedInternalInteger(TIKA_PAGED_TEXT_PREFIX + "number");
    ...
    Property PAGE_NUMBERS =
            Property.reservedInternalIntegerSequence(TIKA_PAGED_TEXT_PREFIX + "numbers");
    ...
    Property PAGE_ROTATION = Property.reservedInternalRational(TIKA_PAGED_TEXT_PREFIX + "rotation");
}
