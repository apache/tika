 ...
 *
 *      <p>
 *      These keys are intended to be a unifying normalization of information within a file. For
 *      some formats, like PDF, where there may be conflicting information in different parts of the
 *      file (xmp vs. docinfo) for the same metadata key, we do what we can, and these keys
 *      represent a normalization of metadata values within a file.
 *      <p>
