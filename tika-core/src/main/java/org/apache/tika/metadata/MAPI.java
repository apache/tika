...
public interface MAPI {
    ...
    String PREFIX_MAPI_PROPERTY =
                    PREFIX_MAPI_META + "property" + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER;

    /**
     * MAPI message class. What type of .msg/MAPI file is it? This is normalized via
     * "mapi_message_classes.properties
     */
    Property MESSAGE_CLASS = Property.internalText(PREFIX_MAPI_META + "message-class");

    /**
     * MAPI message class. What type of .msg/MAPI file is it? This is the raw value that is
     * retrieved from the underlying chunk
     */
    ...
    Property FROM_REPRESENTING_NAME =
                    Property.internalText(PREFIX_MAPI_META + "from-representing-name");

    Property FROM_REPRESENTING_EMAIL =
                    Property.internalText(PREFIX_MAPI_META + "from-representing-email");
    ...
    Property INTERNET_REFERENCES =
                    Property.internalTextBag(PREFIX_MAPI_META + "internet-references");
    ...
    Property BODY_TYPES_PROCESSED =
                    Property.internalTextBag(PREFIX_MAPI_META + "body-types-processed");
