...
public class StandardWriteFilterFactory implements MetadataWriteFilterFactory {
    ...
    public MetadataWriteFilter newInstance() {
        ...
        return new StandardWriteFilter(maxKeySize, maxFieldSize, maxTotalEstimatedBytes,
                        maxValuesPerField, includeFields, excludeFields, includeEmpty);
    }
    ...
    public String toString() {
        return "StandardWriteFilterFactory{" + "includeFields=" + includeFields + ", maxKeySize="
                        + maxKeySize + ", maxFieldSize=" + maxFieldSize
                        + ", maxTotalEstimatedBytes=" + maxTotalEstimatedBytes
                        + ", maxValuesPerField=" + maxValuesPerField + ", includeEmpty="
                        + includeEmpty + '}';
    }
}
