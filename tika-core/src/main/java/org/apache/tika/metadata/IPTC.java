 ...
 * the License.
 *
 * IPTC Metadata Descriptions taken from the IPTC Photo Metadata (July 2010) standard. These parts
 * Copyright 2010 International Press Telecommunications Council.
 */
 ...
 * <p>
 * A collection of {@link Property property definition} constants for the photo metadata properties
 * defined in the IPTC standard.
 *
 * @see <a href=
 *      "http://www.iptc.org/std/photometadata/specification/IPTC-PhotoMetadata-201007_1.pdf">IPTC
 *      Photo Metadata</a>
...
public interface IPTC {
     ...
     * <p>
     * This is a detail of a location with blurred semantics as it does not clearly indicate whether
     * it is the location in the image or the location the photo was taken - which can be different.
     * Two more concise properties are available in IPTC Extension with Location Created and
     ...
     */
    Property COUNTRY_CODE = Property.internalText(PREFIX_IPTC_CORE
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "CountryCode");

    /**
     * A textual description, including captions, of the item's content, particularly used where the
     * object is not text.
     * <p>
     * Note: the XMP property (dc:description) which stores the value of this IPTC Core property is
     * of type Lang Alt. Hence any software agent dealing with this property must abide to the
     ...
     * <p>
     * The IPTC recognizes that the corresponding IPTC Genre NewsCodes needs photo specific
     ...
     */
    Property INTELLECTUAL_GENRE = Property.internalText(PREFIX_IPTC_CORE
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "IntellectualGenre");
     ...
     * <p>
     * Single values of this field should not be restricted to single words but must allow for
     * phrases as well.
     * <p>
     ...
     * <p>
     * Note: Only Scene values from this IPTC taxonomy should be used here. More about the IPTC
     ...
     * <p>
     * Note: Only Subjects from a controlled vocabulary should be used here, free text has to be put
     * into the Keyword element. More about IPTC Subject-NewsCodes at www.newscodes.org.
     */
    Property SUBJECT_CODE = Property.internalTextBag(PREFIX_IPTC_CORE
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "SubjectCode");
     ...
     * <p>
     * If a software system requires explicit time values and no time is given by the Date Created
     * property the software system should default the time to 00:00:00. If the software system does
     * not require an explicit time value the time part should be left empty as it is.
     * <p>
     * Note 1: Any content of the IIM dataset 2:60, Time Created, should be merged to this element.
     * Note 2: Implementers are encouraged to provide the creation date and time from the EXIF data
     * of a digital camera to the user for entering this date for the first time.
     * <p>
     ...
     * <p>
     * Note: As this identifier references a job of the receiver's workflow it must first be issued
     * by the receiver, then transmitted to the creator or provider of the news object and finally
     * added by the creator to this field.
     * <p>
     ...
     * <p>
     * Many use the Title field to store the filename of the image, though the field may be used in
     * many ways. Formal identifiers are provided by the Digital Image Id, or the Registry Entry
     * property of the IPTC Extension.
     * <p>
     * Note 1: This element aligns with the use of Dublin Core's "Title" element. Note 2: the XMP
     ...
     * <p>
     * Copyright ownership can be expressed in a more controlled way using the PLUS fields
     ...
     * <p>
     * Note: the XMP property (dc:rights) which stores the value of this IPTC Core property is of
     ...
     * appropriate.
     * <p>
     * The creator can be expressed in a more controlled way using the "Image Creator" of PLUS in
     ...
     * <p>
     * The IPTC Extension Licensor fields should be used instead of these Creator's Contact Info
     ...
     * <p>
     * Note 1 to user interface implementers: All sub-properties of "Creator's contact information"
     * should be shown as group on the form. Note 2: the CreatorContactInfo sub-properties' naming
     * aligns with the vCard specification RFC 2426.
     */
    Property CREATORS_CONTACT_INFO = Property.internalText(PREFIX_IPTC_CORE
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "CreatorContactInfo");
     ...
     * <p>
     * Note 1: For more formal identifications of the creator or the owner of the copyrights of this
     * image other rights properties may be used. Note 2: This property was named "Credit" by the
     * IIM metadata, then it was renamed to "Provider" in IPTC Core 1.0. In IPTC Core 1.1. it has
     * been renamed to "Credit Line" as the field is used for this purpose by many users.
     * <p>
     ...
     * <p>
     * The PLUS fields of the IPTC Extension can be used in parallel to express the licensed usage
     * in more controlled terms.
     */
     ...
     * <p>
     * The original owner can never change. For that reason the content of this property should
     ...
     * <p>
     * Note 1: to user interface implementers: This field should be part of a "Contact information"
     * group on the form. Note 2: the ContactInfo naming aligns with the vCard specification RFC
     * 2426.
     */
    Property CONTACT_INFO_ADDRESS = Property.internalTextBag(PREFIX_IPTC_CORE
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "CiAdrExtadr");
     ...
     * <p>
     * Multiple email addresses can be given. May have to be separated by a comma in the user
     * interface.
     * <p>
     * Note 1: to user interface implementers: This field should be part of a "Contact information"
     * group on the form. Note 2 to user interface implementers: provide sufficient space to fill in
     * multiple e-mail addresses. Note 3: the ContactInfo naming aligns with the vCard specification
     * RFC 2426.
     */
    Property CONTACT_INFO_EMAIL = Property.internalTextBag(PREFIX_IPTC_CORE
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "CiEmailWork");
     ...
     * Note 1: to user interface implementers: This field should be part of a "Contact information"
     * group on the form. Note 2 to user interface implementers: provide sufficient space to fill in
     * multiple international numbers. Note 3: the ContactInfo naming aligns with the vCard
     ...
     * 2426.
     */
    Property CONTACT_INFO_POSTAL_CODE = Property.internalText(PREFIX_IPTC_CORE
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "CiAdrPcode");
     ...
     * 2426.
     */
    Property CONTACT_INFO_STATE_PROVINCE = Property.internalText(PREFIX_IPTC_CORE
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "CiAdrRegion");
     ...
     * Note 1: to user interface implementers: This field should be part of a "Contact information"
     * group on the form. Note 2 to user interface implementers: provide sufficient space to fill in
     * multiple URLs. Note 3: the ContactInfo naming aligns with the vCard specification RFC 2426.
     */
     ...
     */
    Property ADDITIONAL_MODEL_INFO = Property.internalText(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "AddlModelInfo");

    /**
     * A set of metadata about artwork or an object in the item
     */
    Property ARTWORK_OR_OBJECT = Property.internalTextBag(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "ArtworkOrObject");

    /**
     * A set of metadata about artwork or an object in the item
     */
    Property ORGANISATION_CODE = Property.internalTextBag(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "OrganisationInImageCode");

    /**
     * A term to describe the content of the image by a value from a Controlled Vocabulary.
     * <p>
     * This property is part of the Photo Metadata 2008 specifications, but should not released to
     * the public on the standard Adobe Custom Panels for IPTC metadata or other user interfaces
     ...
     * image.
     * <p>
     * If the location the image was taken in is different from this location the property Location
     * Created should be used too.
     */
    Property LOCATION_SHOWN = Property.internalTextBag(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "LocationShown");

    /**
     * Age of the human model(s) at the time this image was taken in a model released image.
     * <p>
     * The user should be aware of any legal implications of providing ages for young models. Ages
     * below 18 years should not be included.
     */
     ...
     */
    Property ORGANISATION_NAME = Property.internalTextBag(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "OrganisationInImageName");

    /**
     * Name of a person the content of the item is about. For photos that is a person shown in the
     * image.
     */
    Property PERSON = Property.internalTextBag(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "PersonInImage");
     ...
     * <p>
     * The identifier will probably be generated by the technical means of an imaging device or
     ...
     * <p>
     * Any algorithm to create this identifier has to comply with the technical requirements to
     ...
     */
    Property DIGITAL_IMAGE_GUID = Property.internalText(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "DigImageGUID");
     ...
     */
    @Deprecated
    Property DIGITAL_SOURCE_FILE_TYPE = Property.internalText(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "DigitalSourcefileType");

    /**
     * The type of the source of this digital image
     */
    Property DIGITAL_SOURCE_TYPE = Property.internalText(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "DigitalSourceType");

    /**
     * Names or describes the specific event the content relates to.
     * <p>
     * Examples are: a press conference, dedication ceremony, etc. If this is a sub-event of a
     ...
     * <p>
     * Typically an id from a registry is negotiated and applied after the creation of the digital
     * image.
     * <p>
     * Any user interface implementation must show both sub-properties - Item Id and Organisation Id
     * - as corresponding values. Further an input to both fields should be made mandatory.
     */
     ...
     * <p>
     * For identifying the supplier either a well known and/or registered company name or a URL of
     * the company's web site may be used. This property succeeds the Provider property of IPTC Core
     ...
     * This is a PLUS version 1.2 property included in the IPTC Extension schema.
     */
    Property IMAGE_SUPPLIER_NAME = Property.internalText(PREFIX_PLUS
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "ImageSupplierName");
     ...
     * This is a PLUS version 1.2 property included in the IPTC Extension schema.
     */
    Property IMAGE_SUPPLIER_IMAGE_ID = Property.internalText(PREFIX_PLUS
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "ImageSupplierImageID");

    /**
     * The date and optionally time when any of the IPTC photo metadata fields has been last edited
     * <p>
     * The public use of this property is deprecated by IPTC Extension version 1.1. It may only
     ...
     * <p>
     * The value of this property should never be set by software. XMP-aware software should reflect
     * any changes to metadata by the xmp:MetadataDate property of the XMP Basic scheme.
     */
    Property IPTC_LAST_EDITED = Property.internalDate(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "IptcLastEdited");

    /**
     * The location the content of the item was created.
     * <p>
     * If the location in the image is different from the location the photo was taken the IPTC
     * Extension property Location Shown in the Image should be used.
     */
    Property LOCATION_CREATED = Property.internalTextBag(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "LocationCreated");

    /**
     * The maximum available height in pixels of the original photo from which this photo has been
     * derived by downsizing.
     */
    Property MAX_AVAIL_HEIGHT = Property.internalInteger(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "MaxAvailHeight");

    /**
     * The maximum available width in pixels of the original photo from which this photo has been
     * derived by downsizing.
     */
    Property MAX_AVAIL_WIDTH = Property.internalInteger(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "MaxAvailWidth");

    /**
     * The version number of the PLUS standards in place at the time of the transaction.
     * <p>
     * This property was included into the IPTC Extension schema from PLUS version 1.2 as all other
     * PLUS properties. To reflect this the value of "PLUS Version" should be set to the string
     * "1.2.0"
     */
     ...
     * <p>
     * Serves to identify the rights holder/s for the image. The Copyright Owner, Image Creator and
     * Licensor may be the same or different entities.
     * <p>
     * This is a PLUS version 1.2 property included in the IPTC Extension schema.
     */
     ...
     */
    @Deprecated
    String COPYRIGHT_OWNER_ID_WRONG_CASE = PREFIX_PLUS
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "CopyrightOwnerId";
    /**
     ...
     * This is a PLUS version 1.2 property included in the IPTC Extension schema.
     */
    Property COPYRIGHT_OWNER_NAME = Property.internalTextBag(PREFIX_PLUS
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "CopyrightOwnerName");

    /**
     * Creator or creators of the image.
     * <p>
     * The creator can be additionally expressed in free-text using the IPTC Core Creator field. In
     * many countries, the Image Creator must be attributed in association with any use of the
     ...
     * This is a PLUS version 1.2 property included in the IPTC Extension schema.
     */
    Property IMAGE_CREATOR_NAME = Property.internalTextBag(PREFIX_PLUS
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "ImageCreatorName");
    ...
    Property LICENSOR_ID = Property.composite(
                    Property.internalTextBag(PREFIX_PLUS
                                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "LicensorID"),
     ...
     * This is a PLUS version 1.2 property included in the IPTC Extension schema.
     */
    Property LICENSOR_COUNTRY = Property.internalTextBag(PREFIX_PLUS
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "LicensorCountry");
     ...
     * This is a PLUS version 1.2 property included in the IPTC Extension schema.
     */
    Property LICENSOR_EXTENDED_ADDRESS = Property.internalTextBag(PREFIX_PLUS
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "LicensorExtendedAddress");
    ...
    Property LICENSOR_POSTAL_CODE = Property.internalTextBag(PREFIX_PLUS
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "LicensorPostalCode");
     ...
     * This is a PLUS version 1.2 property included in the IPTC Extension schema.
     */
    Property LICENSOR_STREET_ADDRESS = Property.internalTextBag(PREFIX_PLUS
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "LicensorStreetAddress");
     ...
     * This is a PLUS version 1.2 property included in the IPTC Extension schema.
     */
    Property LICENSOR_TELEPHONE_1 = Property.internalTextBag(PREFIX_PLUS
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "LicensorTelephone1");
     ...
     * This is a PLUS version 1.2 property included in the IPTC Extension schema.
     */
    Property LICENSOR_TELEPHONE_2 = Property.internalTextBag(PREFIX_PLUS
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "LicensorTelephone2");
     ...
     * <p>
     * This age should not be displayed to the public on open web portals and the like. But it may
     * be used by image repositories in a B2B enviroment.
     * <p>
     * This is a PLUS version 1.2 property included in the IPTC Extension schema.
     */
    Property MINOR_MODEL_AGE_DISCLOSURE = Property.internalText(PREFIX_PLUS
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "MinorModelAgeDisclosure");
     ...
     * <p>
     * It is recommended to apply the PLUS controlled value Unlimited Model Releases (MR- UMR) very
     * carefully and to check the wording of the model release thoroughly before applying it.
     * <p>
     * This is a PLUS version 1.2 property included in the IPTC Extension schema.
     */
    Property MODEL_RELEASE_STATUS = Property.internalText(PREFIX_PLUS
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "ModelReleaseStatus");
     ...
     * This is a PLUS version 1.2 property included in the IPTC Extension schema.
     */
    Property PROPERTY_RELEASE_ID = Property.internalTextBag(PREFIX_PLUS
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "PropertyReleaseID");
     ...
     * <p>
     * It is recommended to apply the value PR-UPR very carefully and to check the wording of the
     * property release thoroughly before applying it.
     * <p>
     * This is a PLUS version 1.2 property included in the IPTC Extension schema.
     */
    Property PROPERTY_RELEASE_STATUS = Property.internalText(PREFIX_PLUS
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "PropertyReleaseStatus");
     ...
     */
    Property ARTWORK_OR_OBJECT_DETAIL_COPYRIGHT_NOTICE = Property.internalTextBag(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "AOCopyrightNotice");
     ...
     */
    Property ARTWORK_OR_OBJECT_DETAIL_DATE_CREATED = Property.internalTextBag(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "AODateCreated");
     ...
     * geographical hierarchy.
     */
    Property LOCATION_SHOWN_CITY = Property.internalTextBag(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "LocationShownCity");

    /**
     * The ISO code of a country of a location. This element is at the second level of a top-down
     * geographical hierarchy.
     * <p>
     * Note 1: an implementer would have to derive from the length of the value string whether this
     * is the country code from the two or three letter scheme as no explicit indication can be
     * provided.
     */
    Property LOCATION_SHOWN_COUNTRY_CODE = Property.internalTextBag(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "LocationShownCountryCode");

    /**
     * The name of a country of a location. This element is at the second level of a top-down
     * geographical hierarchy.
     */
    Property LOCATION_SHOWN_COUNTRY_NAME = Property.internalTextBag(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "LocationShownCountryName");
     ...
     */
    Property LOCATION_SHOWN_PROVINCE_OR_STATE = Property.internalTextBag(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "LocationShownProvinceState");
     ...
     * hierarchy.
     */
    Property LOCATION_SHOWN_SUBLOCATION = Property.internalTextBag(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "LocationShownSublocation");

    /**
     * The name of a world region of a location. This element is at the first (topI) level of a top-
     * down geographical hierarchy.
     */
    Property LOCATION_SHOWN_WORLD_REGION = Property.internalTextBag(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "LocationShownWorldRegion");

    /**
     * Name of the city of a location. This element is at the fourth level of a top-down
     * geographical hierarchy.
     */
    Property LOCATION_CREATED_CITY = Property.internalText(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "LocationCreatedCity");
     ...
     * provided.
     */
    Property LOCATION_CREATED_COUNTRY_CODE = Property.internalText(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "LocationCreatedCountryCode");

    /**
     * The name of a country of a location. This element is at the second level of a top-down
     * geographical hierarchy.
     */
    Property LOCATION_CREATED_COUNTRY_NAME = Property.internalText(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "LocationCreatedCountryName");
     ...
     * hierarchy.
     */
    Property LOCATION_CREATED_SUBLOCATION = Property.internalText(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "LocationCreatedSublocation");

    /**
     * The name of a world region of a location. This element is at the first (topI) level of a top-
     * down geographical hierarchy.
     */
    Property LOCATION_CREATED_WORLD_REGION = Property.internalText(PREFIX_IPTC_EXT
                    + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + "LocationCreatedWorldRegion");
    ...
    Property[] PROPERTY_GROUP_IPTC_CORE = new Property[] {CITY, COUNTRY, COUNTRY_CODE, DESCRIPTION,
                    HEADLINE, INTELLECTUAL_GENRE, KEYWORDS, PROVINCE_OR_STATE, SCENE_CODE,
                    SUBJECT_CODE, SUBLOCATION, DATE_CREATED, DESCRIPTION_WRITER, INSTRUCTIONS,
                    JOB_ID, TITLE, COPYRIGHT_NOTICE, CREATOR, CREATORS_JOB_TITLE, CREDIT_LINE,
                    RIGHTS_USAGE_TERMS, SOURCE, CONTACT_INFO_ADDRESS, CONTACT_INFO_CITY,
                    CONTACT_INFO_COUNTRY, CONTACT_INFO_EMAIL, CONTACT_INFO_PHONE,
                    CONTACT_INFO_POSTAL_CODE, CONTACT_INFO_STATE_PROVINCE, CONTACT_INFO_WEB_URL};

    Property[] PROPERTY_GROUP_IPTC_EXT = new Property[] {ADDITIONAL_MODEL_INFO, ORGANISATION_CODE,
                    CONTROLLED_VOCABULARY_TERM, MODEL_AGE, ORGANISATION_NAME, PERSON,
                    DIGITAL_IMAGE_GUID, DIGITAL_SOURCE_TYPE, EVENT, IMAGE_SUPPLIER_ID,
                    IMAGE_SUPPLIER_NAME, IMAGE_SUPPLIER_IMAGE_ID, IPTC_LAST_EDITED,
                    MAX_AVAIL_HEIGHT, MAX_AVAIL_WIDTH, PLUS_VERSION, COPYRIGHT_OWNER_ID,
                    COPYRIGHT_OWNER_NAME, IMAGE_CREATOR_ID, IMAGE_CREATOR_NAME, LICENSOR_ID,
                    LICENSOR_NAME, LICENSOR_CITY, LICENSOR_COUNTRY, LICENSOR_EMAIL,
