 ...
 * {@link org.apache.tika.parser.RecursiveParserWrapper}. It allows for finer-grained processing of
...
public abstract class AbstractRecursiveParserWrapperHandler extends DefaultHandler
     ...
     * is currently a no-op aside from tracking embedded depth.
     * <p>
    ...
    /**
     * This is called by {@link #endEmbeddedDocument(ContentHandler, Metadata)}. Users overriding
     * {@link #endEmbeddedDocument(ContentHandler, Metadata)} need to call this unless they are
     * triggering it via <code>super.endEmbeddedDocument(contentHandler, metadata);</code>
     */
