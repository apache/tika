 ...
 * mostly composed of uppercase letters followed by an alphanumeric characters);</li>
 ...
 * organization ({@link StandardOrganizations});</li>
 * <li>increases by 0.25 the score of references which include the word Publication or
 * Standard;</li>
 * <li>increases by 0.25 the score of references which have been found within "Applicable Documents"
 * and equivalent sections;</li>
...
public class StandardsText {
    ...
    private static final String REGEX_FALLBACK = "\\(?" + "(?<mainOrganization>[A-Z]\\w{1,64}+)"
                    ...
                    + "(?<secondOrganization>[A-Z" + "]\\w{1,64}+)" + "\\)?)?" + REGEX_STANDARD_TYPE
                    + "?" + "(-|\\s)?" + REGEX_IDENTIFIER;
     ...
     *        threshold of 0.75 means that only the patterns with score greater than or equal to
     *        0.75 will be returned.
    ...
    private static ArrayList<StandardReference> findStandards(String text,
                    Map<Integer, String> headers, double threshold) {
