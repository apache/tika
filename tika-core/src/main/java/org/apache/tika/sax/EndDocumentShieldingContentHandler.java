...
/**
 * A wrapper around a {@link ContentHandler} which will ignore normal SAX calls to
 * {@link #endDocument()}, and only fire them later. This is typically used to ensure that we can
 * output the metadata before ending the document
 */
