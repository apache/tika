 ...
 * <p>
 * Note that text documents with a character encoding like UTF-16 are better detected with
 * {@link MagicDetector} and an appropriate magic byte pattern.
 *
...
public class TextDetector implements Detector {
     ...
     * <p>
     * The contents of this lookup table are based on the following definition from section 4 of the
