 ...
 * <p>
 * If a pattern matches the given name, then the media type associated with that pattern is returned
 * as the likely content type of the input document. Otherwise the returned type is
 * <code>application/octet-stream</code>.
 * <p>
 * See the {@link #detect(InputStream, Metadata)} method for more details of the matching algorithm.
 *
...
public class NameDetector implements Detector {
     ...
     * <ol>
     * <li>Potential URL query (?...) and fragment identifier (#...) parts are removed from the end
     * of the resource name.</li>
     * <li>Potential leading path elements (up to the last slash or backslash) are removed from the
     * beginning of the resource name.</li>
     * <li>Potential URL encodings (%nn, in UTF-8) are decoded.</li>
     * <li>Any leading and trailing whitespace is removed.</li>
     * </ol>
     * <p>
     * The resulting name string (if any) is then matched in sequence against all the configured
