...
/*
 * Thrown when a parser is asked to allocate more memory than is allowable for a given threshold.
 * For example, the ZCompressorInputStream might be asked to create an array many gigabytes of
 * length by a corrupt file.
 */
