...
public interface ContainerExtractor extends Serializable {
     ...
     * <p>
     * The {@link EmbeddedResourceHandler} you supply will be called for each embedded resource in
     * the container. It is up to you whether you process the contents of the resource or not.
     * <p>
     ...
     * <p>
     * If required, nested containers (such as a .docx within a .zip) can automatically be recursed
     * into, and processed inline. If no recurseExtractor is given, the nested containers will be
