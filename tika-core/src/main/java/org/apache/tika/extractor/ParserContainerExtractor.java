...
public class ParserContainerExtractor implements ContainerExtractor {
    ...
    private class RecursiveParser extends StatefulParser {
        ...
        private RecursiveParser(Parser statelessParser, ContainerExtractor extractor,
        ...
        @Override
        public void parse(InputStream stream, ContentHandler ignored, Metadata metadata,
