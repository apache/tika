...
public interface Renderer extends Serializable {
    ...
    /*
     * At some point, we might need/want to add something like this, where for a given page the
     * requestor or the parser determines that they only want to render e.g. a box within a page.
     * 
