 ...
 * </p>
 * <p>
 * This stream implementation is useful to deal with information which is known to be located at the
 * end of a stream (e.g. ID3 v1 tags). While reading bytes from the underlying stream, a given
