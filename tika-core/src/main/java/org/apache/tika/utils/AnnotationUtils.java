            ...
            if (param != null) {
                if (field.getType().isAssignableFrom(param.getType())) {
                    try {
                        ...
                        LOG.error("Error assigning value '{}' to '{}'", param.getValue(),
                                        param.getName());
                    ...
                    String msg = String.format(Locale.ROOT, "Value '%s' of type '%s' can't be"
                                    + " assigned to field '%s' of defined type '%s'",
                                    param.getValue(), param.getValue().getClass(), field.getName(),
                                    field.getType());
