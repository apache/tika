...
public class DelegatingParser implements Parser {
     ...
     * implementation looks up the delegate parser from the given parse context, and uses an
     * {@link EmptyParser} instance as a fallback. Subclasses can override this method to implement
     ...
     * <p>
     * Subclasses should override this method to parse the top level structure of the given document
     * stream. Parsed sub-streams can be passed to this base class method to be parsed by the
     * configured delegate parser.
     */
