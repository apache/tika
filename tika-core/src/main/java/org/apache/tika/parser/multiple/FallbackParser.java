...
public class FallbackParser extends AbstractMultipleParser {
     ...
     */
    public static final List<MetadataPolicy> allowedPolicies = Arrays.asList(MetadataPolicy.values());
    /**
     * Serial version UID.
     */
    ...
    public FallbackParser(MediaTypeRegistry registry, MetadataPolicy policy, Collection<? extends Parser> parsers) {
