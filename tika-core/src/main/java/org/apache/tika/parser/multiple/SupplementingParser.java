...
public class SupplementingParser extends AbstractMultipleParser {
     ...
     */
    public static final List<MetadataPolicy> allowedPolicies = Arrays.asList(MetadataPolicy.FIRST_WINS,
            MetadataPolicy.LAST_WINS, MetadataPolicy.KEEP_ALL);
    /**
     * Serial version UID.
     */
    ...
    public SupplementingParser(MediaTypeRegistry registry, MetadataPolicy policy, Parser... parsers) {
