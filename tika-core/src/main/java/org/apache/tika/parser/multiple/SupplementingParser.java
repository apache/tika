 ...
 * <p>
 * Warning - currently only one Parser should output any Content to the {@link ContentHandler}, the
 * rest should only output {@link Metadata}. A solution to multiple-content is still being worked
 * on...
 *
...
public class SupplementingParser extends AbstractMultipleParser {
     ...
     */
    public static final List<MetadataPolicy> allowedPolicies = Arrays.asList(
