...
However, for most use cases we recommend using link:../server/index.html[tika-server]
or link:../grpc/index.html[tika-grpc] instead. See
link:getting-started.html[Getting Started] for guidance on choosing the right approach.

== Topics

* link:getting-started.html[Getting Started] - Recommendations and PipesForkParser usage
