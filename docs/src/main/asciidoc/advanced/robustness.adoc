...
**In Tika 4.x, link:../pipes/index.html[Tika Pipes] is the recommended approach for
...
* **Programmatically** - Via `PipesForkParser` in the `tika-pipes-fork-parser` module
  (see link:../using-tika/java-api/getting-started.html[Java API Getting Started])
...
* **Public documentation** of vulnerabilities at link:../security.html[security page]
...
* link:../pipes/index.html[Tika Pipes] - Recommended approach for robust processing
