...
NOTE: The default magic-only path already identifies the crypto *families* — PKCS7/CMS, RFC 5544
timestamped-data, PKCS12. Enable this detector only when a routing or downstream decision depends
on the CMS subtype before parsing.
