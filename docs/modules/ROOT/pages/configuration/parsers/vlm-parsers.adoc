...
embedded images in every other document type are sent to it too. Add a `text-recognizers` list to
choose a different engine for those, or `"text-recognizers": []` for none; see
xref:configuration/index.adoc[Configuration].
