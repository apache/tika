...
binding] does the same for the whole tree in batched requests and is appended to this chain
automatically. See xref:migration-to-4x/chunk-strategies.adoc[Chunk Strategies].
