...
A page the engine cannot render is a warning on the document, not a failed parse, whichever
consumer asked for the render first. A page that breaks the text extraction is still emitted, at
