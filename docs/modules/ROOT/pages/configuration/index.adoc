...
another parser it is never dispatched to, and a WARN at startup says whether it then acts as the
content enricher or never runs at all. Prefer `content-enrichers` for the engine and keep
`parsers` for parsers.
