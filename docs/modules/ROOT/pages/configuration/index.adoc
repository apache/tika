...
NOTE: This list and the `engines` map it names are stable: an entry keeps loading and meaning
...
xref:developers/custom-ocr-engine.adoc[Wiring in Your Own OCR Engine].
