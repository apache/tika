...
* Put the engine in the top-level `content-enrichers` list rather than under `parsers`; every
  default parser stays loaded. `"content-enrichers": []` turns enrichment off everywhere. An engine
