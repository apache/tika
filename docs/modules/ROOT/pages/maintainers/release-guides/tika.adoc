...
./mvnw -Papache-release clean verify
----
...
[source,bash]
----
./mvnw release:perform -Darguments="-DskipITs"
----
...
----
cd target/checkout
./mvnw deploy -Papache-release -rf :<failed-module> -DskipITs
----
...
----
cd target/checkout
./mvnw deploy --non-recursive -Papache-release -Dmaven.deploy.skip=true
----
