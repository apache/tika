...
# 2. Set the version (and the tika-version / tika-javadoc-url attributes) in docs/antora.yml
#    version: '4.0.x'
#    asciidoc:
#      attributes:
#        tika-version: '4.0.0'
#        tika-javadoc-url: 'https://tika.apache.org/4.0.0/api'
...
the doc changes to `docs/4.0.x`, bump its `tika-version` and `tika-javadoc-url`
attributes, rebuild and republish in place.
