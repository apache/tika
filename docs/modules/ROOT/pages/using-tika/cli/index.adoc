...
For processing large numbers of files, run `tika-app` with input/output directories.
Under the hood this uses Tika Pipes batch processing, with forked JVM processes for
fault tolerance.
