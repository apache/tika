...
* **xref:using-tika/server/index.adoc[tika-server]** - REST API, language-agnostic
* **xref:using-tika/grpc/index.adoc[tika-grpc]** - High-performance gRPC protocol
...
* xref:advanced/robustness.adoc[The Robustness of Apache Tika] - Understanding parser risks and mitigations
