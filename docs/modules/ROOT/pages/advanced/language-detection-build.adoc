...
== Current Build: v7 (Wikipedia)

v7 is the current production model. It is trained on Wikipedia dumps (primary)
supplemented by MADLAD for 16 under-resourced languages, and uses 16,384
hash buckets. Compared to v3 (MADLAD), v7 covers fewer languages (203 vs 229)
but is substantially more accurate due to higher training data quality.

=== v7 Training Configuration

* **Corpus:** Wikipedia dumps (primary) + MADLAD supplement for 16 languages
* **Languages:** 203
* **Hash buckets:** 16,384
* **Feature extractor:** `ScriptAwareFeatureExtractor` — character bigrams,
  word unigrams, CJK character unigrams, script-aware boundaries
