...
The same policy applies to the container and to every embedded document. It is
loaded from the config only and is rejected in a per-request `parse-context`
