...
/**
 * String-input specialisation of {@link FeatureExtractor} used by the
 * character-soup language detector. Adds buffer-reuse and preprocessed-text
 * variants for efficient use inside the training loop.
 * <p>
 ...
 */
public interface TextFeatureExtractor extends FeatureExtractor<String> {
