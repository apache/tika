...
/**
 * Parses the output of /bin/ls and counts the number of files and the number of executables using
 * Tika.
 */
public class DirListParser implements Parser {
    ...
    private void addMetadata(Metadata metadata, String filePerms, String numHardLinks,
                    String fileOwner, String fileOwnerGroup, String fileSize, String lastModDate,
                    String fileName) {
