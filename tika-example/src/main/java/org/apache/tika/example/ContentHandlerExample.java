...
public class ContentHandlerExample {
    ...
    /**
     * Example of extracting the plain text of the contents. Will return only the "body" part of the
     * document
     */
    ...
    /**
     * Example of extracting the plain text in chunks, with each chunk of no more than a certain
     * maximum size
     */
