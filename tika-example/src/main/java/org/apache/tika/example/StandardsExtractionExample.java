...
/**
 * Class to demonstrate how to use the {@link StandardsExtractingContentHandler} to get a list of
 * the standard references from every file in a directory.
 *
 * <p>
...
public class StandardsExtractionExample {
    ...
    public static void main(String[] args) {
        if (args.length < 1) {
            System.err.println("Usage: " + StandardsExtractionExample.class.getName()
                            + " /path/to/input");
            System.exit(1);
        }
