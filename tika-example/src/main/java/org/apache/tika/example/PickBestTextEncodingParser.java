...
/**
 * Inspired by TIKA-1443 and https://wiki.apache.org/tika/CompositeParserDiscussion this tries
 * several different text encodings, then does the real text parsing based on which is "best".
 * <p>
 * The logic for "best" needs a lot of work!
 * <p>
 * This is not recommended for actual production use... It is mostly to prove that the
 * {@link AbstractMultipleParser} environment is sufficient to support this use-case
 * <p>
