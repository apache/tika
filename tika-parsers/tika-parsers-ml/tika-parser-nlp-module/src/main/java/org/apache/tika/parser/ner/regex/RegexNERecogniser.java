...
/**
 * This class offers an implementation of {@link NERecogniser} based on Regular Expressions.
 * <p>
 * The default configuration file {@value NER_REGEX_FILE} is used when no argument constructor is
 * used to instantiate this class. The regex file is loaded via
 * {@link Class#getResourceAsStream(String)}, so the file should be placed in the same package path
 * as of this class.
 * </p>
