 ...
 * {@link CTAKESContentHandler} that relies on Apache cTAKES.
 *
 * <p>
 * Apache cTAKES is built on top of <a href="https://uima.apache.org/">Apache UIMA</a> framework and
 * <a href="https://opennlp.apache.org/">OpenNLP</a> toolkit.
 * </p>
 */
public class CTAKESUtils {
    ...
    /**
     * Returns a new UIMA Analysis Engine (AE). This method ensures that only one instance of an AE
     * is created.
     *
     * <p>
     * An Analysis Engine is a component responsible for analyzing unstructured information,
     * discovering and representing semantic content. Unstructured information includes, but is not
     * restricted to, text documents.
     * </p>
     *
     * @param aeDescriptor pathname for XML file including an AnalysisEngineDescription that
     *        contains all of the information needed to instantiate and use an AnalysisEngine.
     ...
     * @throws InvalidXMLException if the input XML is not valid or does not specify a valid
     *         ResourceSpecifier.
     * @throws ResourceInitializationException if a failure occurred during production of the
     *         resource.
     * @throws URISyntaxException if URL of the resource is not formatted strictly according to
     *         RFC2396 and cannot be converted to a URI.
     */
    public static AnalysisEngine getAnalysisEngine(String aeDescriptor, String umlsUser,
                    String umlsPass) throws IOException, InvalidXMLException,
        ...
        if ((umlsUser != null) && (!umlsUser.isEmpty()) && (umlsPass != null)
                        && (!umlsPass.isEmpty())) {
            /*
             * It is highly recommended that you change UMLS credentials in the XML configuration
             * file instead of giving user and password using CTAKESConfig.
             */
    ...
    /**
     * Returns a new JCas () appropriate for the given Analysis Engine. This method ensures that
     * only one instance of a JCas is created. A Jcas is a Java Cover Classes based Object-oriented
     * CAS (Common Analysis System) API.
     *
     * <p>
     * Important: It is highly recommended that you reuse CAS objects rather than creating new CAS
     * objects prior to each analysis. This is because CAS objects may be expensive to create and
     ...
     *         AnalysisEngine's CAS metadata (type system, type priorities, or FS indexes) are
     *         invalid.
     */
     ...
     * @param stream {@link OutputStream} object used to print out information extracted by using
     *        cTAKES.
     ...
     * @param property {@link CTAKESAnnotationProperty} enum used to identify the annotation type.
    ...
    /**
     * Resets cTAKES objects, if created. This method ensures that new cTAKES objects (a.k.a.,
     * Analysis Engine and JCas) will be created if getters of this class are called.
     *
