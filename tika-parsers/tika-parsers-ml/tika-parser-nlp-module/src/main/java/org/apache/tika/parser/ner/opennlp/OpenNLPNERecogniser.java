...
/**
 * This implementation of {@link NERecogniser} chains an array of {@link OpenNLPNameFinder}s for
 * which NER models are available in classpath.
 * <p>
 ...
 * <tr>
 * <td>{@value PERSON}</td>
 * <td>{@value PERSON_FILE}</td>
 * </tr>
 * <tr>
 * <td>{@value LOCATION}</td>
 * <td>{@value LOCATION_FILE}</td>
 * </tr>
 * <tr>
 * <td>{@value ORGANIZATION}</td>
 * <td>{@value ORGANIZATION_FILE}</td>
 * </tr>
 * <tr>
 * <td>{@value TIME}</td>
 * <td>{@value TIME_FILE}</td>
 * </tr>
 * <tr>
 * <td>{@value DATE}</td>
 * <td>{@value DATE_FILE}</td>
 * </tr>
 * <tr>
 * <td>{@value PERCENT}</td>
 * <td>{@value PERCENT_FILE}</td>
 * </tr>
 * <tr>
 * <td>{@value MONEY}</td>
 * <td>{@value MONEY_FILE}</td>
 * </tr>
 * </table>
 *
...
public class OpenNLPNERecogniser implements NERecogniser {
     ...
     *
     * @param models map of entityType -&gt; model path NOTE: the model path should be known to
     *        class loader.
     */
