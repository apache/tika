...
/**
 * This implementation of {@link org.apache.tika.parser.Parser} extracts entity names from text
 * content and adds it to the metadata.
 * <p>
 * All the metadata keys will have a common suffix {@value #MD_KEY_PREFIX}
 * </p>
 * <p>
 * The Named Entity recogniser implementation can be changed by setting the system property
 * {@value #SYS_PROP_NER_IMPL} value to a name of class that implements {@link NERecogniser}
 * contract
 * </p>
 *
...
public class NamedEntityParser implements Parser {
    ...
    private synchronized void initialize(ParseContext context) {
        ...
        for (String className : classNames) {
            ...
            try {
                NERecogniser recogniser = (NERecogniser) Class.forName(className)
    ...
    /**
     * writes the content to the given XHTML content handler
     *
