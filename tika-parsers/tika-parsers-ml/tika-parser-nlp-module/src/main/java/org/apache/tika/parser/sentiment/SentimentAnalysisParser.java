...
/**
 * This parser classifies documents based on the sentiment of document. The classifier is powered by
 * Apache OpenNLP's Maximum Entropy Classifier
 */
public class SentimentAnalysisParser implements Parser, Initializable {
     ...
     * <ul>
     * <li>a HTTP or HTTPS URL (Not recommended for production use since no caching is implemented)
     * </li>
