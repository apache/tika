 ...
 * copyright owlocationNameEntitieship. The ASF licenses this file to You under the Apache License,
...
public class RegexNERecogniserTest {
    ...
    public void testGetEntityTypes() throws Exception {
        ...
        Tika tika = new Tika(new TikaConfig(
                        NamedEntityParser.class.getResourceAsStream("tika-config.xml")));
