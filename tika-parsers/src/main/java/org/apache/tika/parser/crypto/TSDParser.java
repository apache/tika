...
public class TSDParser extends AbstractParser {
	...
	public Set<MediaType> getSupportedTypes(ParseContext context) {
		//log.info("TSDParser --> getSupportedTypes ParseContext in: " + context);
		//log.info("TSDParser --> getSupportedTypes SUPPORTED_TYPES: " + SUPPORTED_TYPES);
	...
	public void parse(InputStream stream, ContentHandler handler,
		...
		//log.info("TSDParser --> parse START!");
		//log.info("TSDParser --> InputStream in: " + stream);
		//log.info("TSDParser --> ContentHandler in: " + handler);
		//log.info("TSDParser --> Metadata in: " + metadata);
		//log.info("TSDParser --> ParseContext in: " + context);
        ...
        //log.info("TSDParser --> parse metadata: " + metadata);
        
        XHTMLContentHandler xhtml = new XHTMLContentHandler(handler, metadata);
        xhtml.startDocument();
        xhtml.endDocument();
        
        //log.info("TSDParser --> parse END!");
	}
	...
	private List<TSDMetas> buildMetas(InputStream stream) {
        ...
        try {
        	 ...
        	 //log.info("TSDParser --> buildMetas START!");
			 ...
			 for (int i=0; i < tokens.length; i++) {
				 ...
				 //log.info("TSDParser --> buildMetas genTime: " + tsdMetas.getEmitDateStr());
				 //log.info("TSDParser --> buildMetas policyId: " + tsdMetas.getPolicyId());
				 //log.info("TSDParser --> buildMetas serialNumber: " + tsdMetas.getSerialNumberFormatted());
				 //log.info("TSDParser --> buildMetas tsa: " + tsdMetas.getTSAstr());
				 //log.info("TSDParser --> buildMetas algorithm: " +  tsdMetas.getAlgorithmName());
				 
				 //log.info("TSDParser --> tsdMetas instance built: " + tsdMetas);
				 tsdMetasList.add(tsdMetas);
			 }
			 
             //log.info("TSDParser --> tsdMetas list: " + tsdMetasList);
             //log.info("TSDParser --> buildMetas END!");
             
        } catch (Exception ex) {
             //log.error("TSDParser --> buildMetas Error: ", ex);
