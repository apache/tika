 ...
 * <p>
 * The motivation is that "geom" and "data" columns are intrinsic to geopkg and are not regular
 * embedded files. Tika treats all blob columns as, potentially, embedded files -- this can add
 * dramatically to the time to parse geopkg files, which might have hundreds of thousands of
 * uninteresting blobs.
 * <p>
