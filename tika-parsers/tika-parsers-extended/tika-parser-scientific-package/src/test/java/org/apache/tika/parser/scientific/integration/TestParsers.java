...
/**
 * We fixed parser ordering in 2.4.1. This confirms going forward that the integration of
 * tika-parsers-standard with the tika-parser-scientific package maintains parser order.
 *
 * This does not currently test parsers added after 2.4.1.
 *
 * We included 2.4.0 for historical reasons to show what the behavior was before the fix.
 */
public class TestParsers {
    ...
    public void testDiffsFrom241() throws Exception {
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(
                        getClass().getResourceAsStream(path241), StandardCharsets.UTF_8))) {
