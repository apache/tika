...
public class TestMimeTypes {
    ...
    public void testPKCSSignatures() throws Exception {
        ...
        assertType("application/pkcs7-mime", "testPKCS17Sig-v4.xml.p7m");
        ...
        assertTypeByData("application/pkcs7-mime", "testPKCS17Sig-v4.xml.p7m");
    }
    ...
    public void testPKCS7() throws Exception {
        //from rob975 on https://github.com/apache/tika/pull/267
        // application/pkcs7-* media types
        // this tests only the magic detector, which is not sufficient. See the ASN1Detector
        ...
        /* can't distinguish these with file extension and magic
        ...
        */
        assertTypeByData("application/pkcs7-mime", "testPKCS7_certs_only_def.p7c");
        assertTypeByData("application/pkcs7-mime", "testPKCS7_certs_only_ind.p7c");
        assertTypeByData("application/pkcs7-mime", "testPKCS7_enveloped_def.p7m");
        assertTypeByData("application/pkcs7-mime", "testPKCS7_enveloped_ind.p7m");
        assertTypeByData("application/pkcs7-mime", "testPKCS7_signature_def.p7s");
        assertTypeByData("application/pkcs7-mime", "testPKCS7_signature_ind.p7s");
        assertTypeByData("application/pkcs7-mime", "testPKCS7_signed_data_def.p7m");
        assertTypeByData("application/pkcs7-mime", "testPKCS7_signed_data_def.pem");
        assertTypeByData("application/pkcs7-mime", "testPKCS7_signed_data_ind.p7m");
    }
