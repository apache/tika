 ...
 * due to a need for the full set of translators
 */
public class TikaTranslatorConfigTest extends AbstractTikaConfigTest {
    ...
    /**
     * Currently, Translators don't support Composites, so if multiple translators are given, throw
     * a TikaConfigException
     */
    @Test
