...
class ParserFuzzer {
    ...
    public static void parseOne(Parser parser, byte[] bytes, ParseContext parseContext)
                    throws Throwable {
    ...
    public static void parseRMetaFile(Parser parser, byte[] bytes) throws Throwable {
        ...
        RecursiveParserWrapperHandler rpwh =
    ...
    public static void parseBytes(Parser parser, byte[] bytes, ParseContext parseContext)
                    throws Throwable {
    ...
    public static void parseFile(Parser parser, byte[] bytes, ParseContext parseContext)
                    throws Throwable {
        ContentHandler handler = new ToTextContentHandler();
        // make sure that other parsers cannot be invoked
        parseContext.set(Parser.class, parser);
