...
public class TestParsers extends MultiThreadedTikaTest {
    ...
    public void testWORDxtraction() throws Exception {
        ...
        try (TikaInputStream tis =
                        TikaInputStream.get(getResourceAsStream("/test-documents/testWORD.doc"))) {
    ...
    public void testOptionalHyphen() throws Exception {
        ...
        for (String extension : extensions) {
            try (TikaInputStream tis = TikaInputStream.get(getResourceAsStream(
                            "/test-documents/testOptionalHyphen." + extension))) {
                ...
                assertTrue(content.contains("optionalhyphen")
                                ...
                                "optional hyphen was not handled for '" + extension
                                                + "' file type: " + content); // hyphenation point
            }
        }
