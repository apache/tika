...
public abstract class AbstractOOXMLDocxPackageTest extends TikaTest {
    ...
    public void testAltFileMHTChunk() throws Exception {
        List<Metadata> metadataList =
                getRecursiveMetadata("testAltChunkMHT.docx", getParseContext());
    ...
    public void testAltFileHTMLChunk() throws Exception {
        List<Metadata> metadataList =
                getRecursiveMetadata("testAltChunkHTML.docx", getParseContext());
