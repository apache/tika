...
/**
 * A class to process the attributes of an HTML meta tag in order to extract a character set. The
 * user should repeatedly call {@link #processAttribute} on each attributes of the tag, then update
 * its current detection result with {@link #updateDetectedCharset(CharsetDetectionResult)}
 * <p>
