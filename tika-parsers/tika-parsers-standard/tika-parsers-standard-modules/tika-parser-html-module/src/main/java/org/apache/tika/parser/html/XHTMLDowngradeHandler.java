...
/**
 * Content handler decorator that downgrades XHTML elements to old-style HTML elements before
 * passing them on to the decorated content handler. This downgrading consists of dropping all
 * namespaces (and namespaced attributes) and uppercasing all element names. Used by the
 * {@link HtmlParser} to make all incoming HTML look the same.
 */
