...
/**
 * Character encoding detector for determining the character encoding of a HTML document based on
 * the potential charset parameter found in a Content-Type http-equiv meta tag somewhere near the
 * beginning. Especially useful for determining the type among multiple closely related encodings
...
public class HtmlEncodingDetector implements EncodingDetector {
    ...
    /**
     * HTML can include non-iana supported charsets that Java recognizes, e.g. "unicode". This can
     * lead to incorrect detection/mojibake. Ignore charsets in html meta-headers that are not
     * supported by IANA. See: TIKA-2592
     */
    ...
    static {
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(
                        HtmlEncodingDetector.class.getResourceAsStream(
                                        "StandardCharsets_unsupported_by_IANA.txt"),
