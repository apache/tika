 ...
 * Implementations should return NULL if the file lacks a given tag, or if the tag isn't defined for
 * the version.
 * <p>
 * Note that so far, only the ID3v1 core tags are listed here. In future, we may wish to add more to
 * cover the extra tags that our ID3v2 handlers can produce.
 */
public interface ID3Tags {
     ...
     */
    String[] GENRES = new String[] {/* 0 */ "Blues", /* 1 */ "Classic Rock", /* 2 */ "Country",
                    ...
                    /* 55 */ "Dream", /* 56 */ "Southern Rock", /* 57 */ "Comedy", /* 58 */ "Cult",
    ...
    /**
     * Retrieves the comments, if any. Files may have more than one comment, but normally only one
     * with any language/description pair.
     */
