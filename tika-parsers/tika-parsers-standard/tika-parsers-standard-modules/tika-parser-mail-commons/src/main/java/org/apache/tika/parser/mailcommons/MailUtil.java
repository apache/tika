...
public class MailUtil {
    ...
    /**
     * This tries to split a "from" or "to" value into a person field and an email field. This does
     * not handle RFC encoded strings (e.g. "=?iso-8859-1?Q?H=E9roux_Louise?"), you must decode them
     * first.
     *
     * @param string
