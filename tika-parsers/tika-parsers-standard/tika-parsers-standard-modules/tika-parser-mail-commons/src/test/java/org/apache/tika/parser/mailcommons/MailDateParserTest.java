...
public class MailDateParserTest {
    ...
    public void testDateTimesWithTimeZones() throws Exception {
        ...
        for (String dateString : new String[] {
                        // with timezone info:
                        "Mon, 9 May 16 01:32:00 GMT", "9 May 16 01:32:00 GMT",
                        "Monday, 9 May 16 01:32:00 GMT", "Mon, 9 May 2016 01:32:00 UTC",
                        "9 May 2016 01:32:00 UTC", "09 May 2016 01:32:00 UTC",
                        "Mon, 9 May 2016 01:32:00Z", "Mon, 9 May 2016 01:32:00 Z",
                        "Mon, 9 May 2016 01:32:00 GMT", "Mon, 9 May 2016 01:32:00GMT",
                        "Mon, 9 May 2016 01:32:00 UTC", "Mon, 9 May 2016 01:32:00UTC",
                        ...
                        "       9 May 2016 3:32:00 +0200", "Mon, 9 May 2016 3:32:00 +02:00",
                        "9 May 2016 3:32:00 +02:00", "Mon, 9 May 2016 3:32:00+02:00",
                        "Mon, 9 May 2016 3:32:00+0200", "      Sun, 8 May 2016 21:32:00 EST",
    ...
    public void oneOff() throws Exception {
         ...
         * System.out.println(simpleDateFormat.format(new Date())); DateTimeFormatter formatter =
         * DateTimeFormatter .ofPattern("yyyy-MM-dd'T'HH:mm:ss.S OOOO") .withLocale(Locale.US);
         * String date = formatter.format(ZonedDateTime.now(ZoneOffset.UTC));
         * System.out.println("String: " + date); System.out.println("parsed: " +
         * formatter.parse(date) + " from " + date);
         */
    ...
    public void testDateTimesWithNoTimeZone() throws Exception {
        ...
        for (String dateString : new String[] {"Mon, 9 May 2016 01:32:00",
    ...
    public void testTrickyDates() throws Exception {
        ...
        for (String dateString : new String[] {"11/14/08", "1/14/08", "1/2/08", "12/1/2008",
                        "12/02/1996", "96/1/02", "96/12/02", "96/12/2", "1996/12/02",
                        "Mon, 29 Jan 96 14:02 GMT", "7/20/95 1:12PM", "08/14/2000  12:48 AM",
                        "8/4/2000  1:48 AM", "06/24/2008, Tuesday, 11 AM",}) {
