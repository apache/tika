...
/**
 * DWGReadFormatRemover removes the formatting from the text from libredwg files so only the raw
 * text remains. What needs to be cleaned has been found on the following websites:
 * <p>
