...
/**
 * Limited testing for the iWorks 13 format parser, which currently doesn't do much more than
 * detection and handling some embedded files....
 */
public class IWork13ParserTest extends TikaTest {
    ...
    public void testParseNumbers13() throws Exception {
        ...
        assertEquals(IWork13PackageParser.IWork13DocumentType.UNKNOWN13.getType().toString(),
                        metadata.get(Metadata.CONTENT_TYPE));
