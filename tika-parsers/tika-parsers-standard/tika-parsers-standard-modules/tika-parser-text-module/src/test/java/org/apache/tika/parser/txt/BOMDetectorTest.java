...
public class BOMDetectorTest extends TikaTest {
    ...
    public void testBasic() throws Exception {
        ...
        for (ByteOrderMark bom : new ByteOrderMark[] {ByteOrderMark.UTF_8, ByteOrderMark.UTF_16BE,
            ...
            try (BOMInputStream bomInputStream = BOMInputStream.builder()
                            .setInputStream(UnsynchronizedByteArrayInputStream.builder()
                                            .setByteArray(bos.toByteArray()).get())
                            .setByteOrderMarks(ByteOrderMark.UTF_8, ByteOrderMark.UTF_32BE,
            ...
            try (UnsynchronizedByteArrayInputStream is = UnsynchronizedByteArrayInputStream
                            .builder().setByteArray(bos.toByteArray()).get()) {
                assertEquals(Charset.forName(bom.getCharsetName()),
                                detector.detect(is, new Metadata()));
                int cnt = 0;
                int c = is.read();
                while (c > -1) {
                    cnt++;
    ...
    public void testShort() throws Exception {
        ...
        for (ByteOrderMark bom : new ByteOrderMark[] {ByteOrderMark.UTF_8, ByteOrderMark.UTF_16BE,
            ...
            bytes[1] = (byte) 32;
            bytes[2] = (byte) 32;
            try (InputStream is = UnsynchronizedByteArrayInputStream.builder().setByteArray(bytes)
                            .get()) {
