...
public enum StringsEncoding {
    ...
    SINGLE_8_BIT('S', "single-8-bit-byte"), BIGENDIAN_16_BIT('b',
                    "16-bit bigendian"), LITTLEENDIAN_16_BIT('l',
                                    "16-bit littleendian"), BIGENDIAN_32_BIT('B',
                                                    "32-bit bigendian"), LITTLEENDIAN_32_BIT('L',
                                                                    "32-bit littleendian");
