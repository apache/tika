...
/**
 * Overrides Excel's General format to include more significant digits than the MS Spec allows. See
 * TIKA-2025.
 */
public class TikaExcelDataFormatter extends DataFormatter {
    ...
    public String formatRawCellContents(double value, int formatIndex, String formatString,
        ...
        if (DateUtil.isADateFormat(formatIndex, formatString)) {
            String activeDateFormatString = (dateOverrideFormatString == null) ? formatString
