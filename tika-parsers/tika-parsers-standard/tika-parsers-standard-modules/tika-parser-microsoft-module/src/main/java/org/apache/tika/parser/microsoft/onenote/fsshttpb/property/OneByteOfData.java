...
/**
 * This class is used to represent the property contains 1 byte of data in the PropertySet.rgData
 * stream field.
 */
public class OneByteOfData implements IProperty {
    ...
    /**
     * This method is used to deserialize the OneByteOfData from the specified byte array and start
     * index.
     *
