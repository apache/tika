...
public class ChmLzxState implements Cloneable {
    ...
    public String toString() {
        ...
        sb.append("actual decoding window:=").append(getWindow()).append(System.getProperty("line.separator"));
        ...
        sb.append("have we started decoding at all yet?:=").append(getHadStarted())
                .append(System.getProperty("line.separator"));
        sb.append("type of this block:=").append(getBlockType()).append(System.getProperty("line.separator"));
        ...
        sb.append("have we seen any translatable data yet?:=").append(getIntelState())
                .append(System.getProperty("line.separator"));
        sb.append("R0 for the LRU offset system:=").append(getR0()).append(System.getProperty("line.separator"));
        sb.append("R1 for the LRU offset system:=").append(getR1()).append(System.getProperty("line.separator"));
        sb.append("R2 for the LRU offset system:=").append(getR2()).append(System.getProperty("line.separator"));
