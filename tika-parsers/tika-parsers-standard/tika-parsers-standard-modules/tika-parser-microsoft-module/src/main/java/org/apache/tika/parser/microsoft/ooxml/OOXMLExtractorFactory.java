...
/**
 * Figures out the correct {@link OOXMLExtractor} for the supplied document and returns it.
 */
public class OOXMLExtractorFactory {
    ...
    private static XSLFRelation[] XSLF_RELATIONS = new XSLFRelation[] {XSLFRelation.MAIN,
                    XSLFRelation.MACRO, XSLFRelation.MACRO_TEMPLATE, XSLFRelation.PRESENTATIONML,
            ...
            if (poiExtractor instanceof XSSFBEventBasedExcelExtractor) {
                ...
                throw new TikaException(
                                "Expecting UserModel based POI OOXML extractor with a document, but none"
                                                + " found. " + "The extractor returned was a "
                                                + poiExtractor);
