...
/**
 * This class is used to represent the property contains 8 bytes of data in the PropertySet.rgData
 * stream field.
 */
public class EightBytesOfData implements IProperty {
    ...
    /**
     * This method is used to deserialize the EightBytesOfData from the specified byte array and
     * start index.
     *
