...
/**
 * A Format that allows up to 15 significant digits for integers. This goes against the Microsoft
 * spec, but it preserves information for long strings of digits.
 * <p>
