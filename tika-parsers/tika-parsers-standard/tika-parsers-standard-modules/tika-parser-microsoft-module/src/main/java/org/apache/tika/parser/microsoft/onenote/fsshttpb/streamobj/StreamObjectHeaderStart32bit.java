...
public class StreamObjectHeaderStart32bit extends StreamObjectHeaderStart {
    /**
     * Gets or sets an optional compact uint64 that specifies the length in bytes for additional
     * data (if any). This field MUST be specified if the Length field contains 32767 and MUST NOT
     * be specified if the Length field contains any other value than 32767.
     */
    public Compact64bitInt largeLength;

    /**
     * Initializes a new instance of the StreamObjectHeaderStart32bit class with specified type and
     * length.
     *
    ...
    /**
     * Initializes a new instance of the StreamObjectHeaderStart32bit class, this is the default
     * constructor.
     */
    ...
    /**
     * This method is used to convert the element of StreamObjectHeaderStart32bit basic object into
     * a byte List.
     *
     * @return Return the byte list which store the byte information of
    ...
    /**
     * This method is used to deserialize the StreamObjectHeaderStart32bit basic object from the
    ...
    protected int doDeserializeFromByteArray(byte[] byteArray, int startIndex)
        ...
        if (this.headerType != StreamObjectHeaderStart.STREAM_OBJECT_HEADER_START_32_BIT) {
            throw new TikaException(String.format(Locale.US,
                            ...
                            StreamObjectHeaderStart.STREAM_OBJECT_HEADER_START_32_BIT,
                            this.headerType));
        }
