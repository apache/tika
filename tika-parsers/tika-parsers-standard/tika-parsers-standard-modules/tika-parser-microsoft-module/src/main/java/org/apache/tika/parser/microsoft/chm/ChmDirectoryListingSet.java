    ...
    private void enumerateChmDirectoryListingList(ChmItsfHeader chmItsHeader, ChmItspHeader chmItspHeader)
        ...
        try {
            ...
            for (int i = startPmgl; i >= 0;) {
                ...
                dir_chunk = ChmCommons.copyOfRange(getData(), start, start + (int) chmItspHeader.getBlock_len());
    ...
    private void enumerateOneSegment(byte[] dir_chunk) throws ChmParsingException, TikaException {
        ...
        if (dir_chunk != null) {
            ...
            /*&& dir_chunk[placeHolder - 1] != 115*/) {
                ...
                dle.setName(new String(
                        ChmCommons.copyOfRange(dir_chunk, placeHolder, (placeHolder + dle.getNameLength())), UTF_8));
