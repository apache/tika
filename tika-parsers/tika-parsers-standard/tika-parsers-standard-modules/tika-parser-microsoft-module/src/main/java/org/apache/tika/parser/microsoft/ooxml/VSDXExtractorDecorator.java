...
public class VSDXExtractorDecorator extends AbstractOOXMLExtractor {
    ...
    public VSDXExtractorDecorator(ParseContext context, POIXMLTextExtractor extractor) {
        //keep the 3x extractor-based ctor (factory + AbstractOOXMLExtractor unchanged);
