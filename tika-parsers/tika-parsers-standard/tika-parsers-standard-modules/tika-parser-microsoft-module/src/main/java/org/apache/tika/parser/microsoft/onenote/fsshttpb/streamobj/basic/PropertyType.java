...
public enum PropertyType {
    ...
    /**
     * The property contains a prtFourBytesOfLengthFollowedByData in the PropertySet.rgData stream
     * field.
     */
    ...
    ObjectID(0x8),
    /**
     * The property contains an array of CompactID structures in the
     * ObjectSpaceObjectPropSet.OSIDs.body stream field.
     */
    ArrayOfObjectIDs(0x9),
    /**
     * The property contains one CompactID structure in the ObjectSpaceObjectPropSet.OSIDs.body
     * stream field.
     */
    ObjectSpaceID(0xA),
    /**
    ...
    /**
     * The property contains one CompactID in the ObjectSpaceObjectPropSet.ContextIDs.body stream
     * field.
     */
    ContextID(0xC),
    /**
     * The property contains an array of CompactID structures in the
     * ObjectSpaceObjectPropSet.ContextIDs.body stream field.
     */
    ArrayOfContextIDs(0xD),
    /**
     * The property contains a prtArrayOfPropertyValues structure in the PropertySet.rgData stream
     * field.
     */
    ArrayOfPropertyValues(0x10),
    /**
     * The property contains a child PropertySet structure in the PropertySet.rgData stream field of
     * the parent PropertySet.
     */
    PropertySet(0x11);
