...
/**
 * This class is used to represent the property contains 4 bytes of data in the PropertySet.rgData
 * stream field.
 */
public class FourBytesOfData implements IProperty {
    ...
    /**
     * This method is used to deserialize the FourBytesOfData from the specified byte array and
     * start index.
     *
