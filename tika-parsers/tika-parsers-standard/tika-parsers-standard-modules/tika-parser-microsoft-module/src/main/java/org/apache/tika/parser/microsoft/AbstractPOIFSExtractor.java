...
abstract class AbstractPOIFSExtractor {
    ...
    /**
     * Returns the password to be used for this file, or null if no / default password should be
     * used
     */
    ...
    protected void handleEmbeddedResource(TikaInputStream resource, Metadata embeddedMetadata,
                    String filename, String relationshipID, ClassID storageClassID,
    ...
    protected void handleEmbeddedOfficeDoc(DirectoryEntry dir, Metadata metadata,
        ...
        if (type == POIFSDocumentType.OLE10_NATIVE) {
            ...
            // for Outlook try to use the title first so that we don't wind up with
            // __substg1.0_37...
    ...
    private String getContentsEntryName(DirectoryEntry dir) {
        /*
         * if (dir.hasEntry("CorelDRAW")) { contentsEntry = (DocumentEntry)
         * dir.getEntry("CorelDRAW");}
         */
    ...
    private void parseEmbedded(DirectoryEntry parentDir, TikaInputStream tis,
                    XHTMLContentHandler xhtml, Metadata metadata, boolean outputHtml)
                    throws IOException, SAXException {
    ...
    public static String tryToGetMsgTitle(DirectoryEntry node, String defaultVal) {
        ...
        for (String entryName : new String[] {"__substg1.0_0037001F", "__substg1.0_0E1D001F",
