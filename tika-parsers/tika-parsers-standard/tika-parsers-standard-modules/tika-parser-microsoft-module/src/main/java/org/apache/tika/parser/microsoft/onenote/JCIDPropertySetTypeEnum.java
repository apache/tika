...
enum JCIDPropertySetTypeEnum {
    jcidReadOnlyPersistablePropertyContainerForAuthor(0x00120001), jcidPersistablePropertyContainerForTOC(0x00020001),
    ...
    jcidPageManifestNode(0x00060037), jcidConflictPageMetaData(0x00020038), jcidVersionHistoryContent(0x0006003C),
    jcidVersionProxy(0x0006003D), jcidNoteTagSharedDefinitionContainer(0x00120043), jcidRevisionMetaData(0x00020044),
