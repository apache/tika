...
class FileNodeListHeader {
     ...
     *        file node list containing the fragment. The nFragmentSequence field of the first
     *        fragment in a given file node list MUST be 0 and the nFragmentSequence fields of all
     *        subsequent fragments in this list MUST be sequential.
     */
    ...
    public String toString() {
        return "FileNodeListHeader{" + "position=" + "0x"
                        + StringUtils.leftPad(Long.toHexString(position), 8, '0')
                        + ", fileNodeListId=" + fileNodeListId + ", nFragmentSequence="
                        + nFragmentSequence + '}';
    }
}
