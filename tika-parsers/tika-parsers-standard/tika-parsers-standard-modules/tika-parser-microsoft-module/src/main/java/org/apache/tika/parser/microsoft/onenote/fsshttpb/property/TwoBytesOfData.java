...
/**
 * This class is used to represent the property contains 2 bytes of data in the PropertySet.rgData
 * stream field.
 */
public class TwoBytesOfData implements IProperty {
    ...
    /**
     * This method is used to deserialize the TwoBytesOfData from the specified byte array and start
     * index.
     *
