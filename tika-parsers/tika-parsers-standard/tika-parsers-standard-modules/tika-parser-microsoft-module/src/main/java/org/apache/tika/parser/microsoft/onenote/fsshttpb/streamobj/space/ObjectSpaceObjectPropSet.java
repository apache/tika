...
public class ObjectSpaceObjectPropSet {
    ...
    /**
     * This method is used to deserialize the ObjectSpaceObjectPropSet from the specified byte array
     * and start index.
     *
     ...
     *
     * @return Return the byte list which store the byte information of the
