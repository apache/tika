...
public class DataElement extends StreamObject {
    ...
    public DataElement(DataElementType type, DataElementData data) {
        ...
        this.data = data;
        this.dataElementExGuid = new ExGuid(SequenceNumberGenerator.GetCurrentSerialNumber(),
                        UUID.randomUUID());
    ...
    protected void deserializeItemsFromByteArray(byte[] byteArray, AtomicInteger currentIndex,
        ...
        try {
            ...
            this.dataElementType = DataElementType.fromIntVal((int) BasicObject
                            .parse(byteArray, index, Compact64bitInt.class).getDecodedValue());
        } catch (Exception e) {
        ...
        if (DATA_ELEMENT_DATA_TYPE_MAPPING.containsKey(this.dataElementType)) {
            try {
                this.data = (DataElementData) DATA_ELEMENT_DATA_TYPE_MAPPING
                                .get(this.dataElementType).getDeclaredConstructor().newInstance();
            ...
            try {
                index.addAndGet(this.data.deserializeDataElementDataFromByteArray(byteArray,
                                index.get()));
            } catch (Exception e) {
                throw new DataElementParseErrorException(index.get(), e);
            }
    ...
    protected int serializeItemsToByteList(List<Byte> byteList) throws IOException, TikaException {
        ...
        byteList.addAll(new Compact64bitInt(this.dataElementType.getIntVal())
                        .serializeToByteList());
