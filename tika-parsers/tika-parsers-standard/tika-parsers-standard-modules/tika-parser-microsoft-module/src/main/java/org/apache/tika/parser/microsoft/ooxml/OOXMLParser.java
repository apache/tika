...
public class OOXMLParser extends AbstractOfficeParser {
    ...
    protected static final Set<MediaType> SUPPORTED_TYPES = Collections.unmodifiableSet(new HashSet<>(
     ...
     * by Tika and/or POI.
     */
    protected static final Set<MediaType> UNSUPPORTED_OOXML_TYPES = Collections.EMPTY_SET;
    /**
     * Serial version UID
     */
