...
public class LibPstParserConfig implements Serializable {
    ...
    /**
     * In initial tests, setting this to true resulted in more emails being extracted. It did
     * dramatically slow down processing time. :(
     */
    private boolean isDebug = true;

    /**
     * Should readpst also output msg files for processing. In an initial test, not as many
     * attachments were extracted from msg files. Not yet clear if that is a POI limitation or a
     * problem with libpst
     */
