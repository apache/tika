...
public class HeaderCell {
    ...
    public static HeaderCell createInstance(ObjectGroupDataElementData objectElement)
        ...
        for (int i = 0; i < objectElement.objectGroupDeclarations.objectDeclarationList
                        .size(); i++) {
            if (objectElement.objectGroupDeclarations.objectDeclarationList
                            .get(i).objectPartitionID != null
                            && objectElement.objectGroupDeclarations.objectDeclarationList
                                            .get(i).objectPartitionID.getDecodedValue() == 1) {
