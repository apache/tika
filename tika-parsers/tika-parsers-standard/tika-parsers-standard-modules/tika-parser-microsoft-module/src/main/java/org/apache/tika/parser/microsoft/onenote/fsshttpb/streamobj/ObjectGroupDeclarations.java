    ...
    protected void deserializeItemsFromByteArray(byte[] byteArray, AtomicInteger currentIndex,
        ...
        while ((headerLength =
            ...
            if (header.get().type == StreamObjectTypeHeaderStart.ObjectGroupObjectDeclare) {
                ...
                this.objectDeclarationList.add((ObjectGroupObjectDeclare) StreamObject
                                .parseStreamObject(header.get(), byteArray, index));
            } else if (header
                            .get().type == StreamObjectTypeHeaderStart.ObjectGroupObjectBLOBDataDeclaration) {
                index.addAndGet(headerLength);
                this.objectGroupObjectBLOBDataDeclarationList
                                .add((ObjectGroupObjectBLOBDataDeclaration) StreamObject
                                                .parseStreamObject(header.get(), byteArray, index));
            } else {
