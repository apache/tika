 ...
 * <p>
 * This class uses SAX to scrape that info out of the styles.xml file. If either the styleId or the
 * style's name is null, no information is recorded.
 */
        ...
        public void startElement(String uri, String localName, String qName, Attributes atts)
            ...
            if (uri == null || OOXMLWordAndPowerPointTextHandler.W_NS.equals(uri)) {
                if ("style".equals(localName)) {
                    currentStyleId = atts.getValue(OOXMLWordAndPowerPointTextHandler.W_NS,
                                    "styleId");
