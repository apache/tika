...
/**
 * This is designed to extract features that are useful for forensics, e-discovery and digital
 * preservation. Specifically, the presence of: tracked changes, hidden text, comments and comment
 * authors. Because several of these features can be placed on run properties, which can be in lots
 * of places, we're scraping the document xml
 */
public class XWPFFeatureExtractor {
    ...
    private static class FeatureHandler extends DefaultHandler {
        ...
        public void startElement(String uri, String localName, String qName, Attributes atts)
            ...
            // the current check could lead to false positives where <w:vanish/> is around a space
            // or no text.
