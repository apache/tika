...
public class PSTMailItemParser implements Parser {
    ...
    private void parseMailAndAttachments(PSTMessage pstMsg, XHTMLContentHandler handler,
    ...
    private void parseMailItem(PSTMessage pstMail, XHTMLContentHandler xhtml, Metadata metadata,
        ...
        if (!StringUtils.isBlank(htmlChunk)) {
            Parser htmlParser = EmbeddedDocumentUtil.tryToFindExistingLeafParser(JSoupParser.class,
                            context);
            if (htmlParser == null) {
    ...
    private void parseMailAttachment(XHTMLContentHandler xhtml, PSTAttachment attachment,
                    Metadata metadata, EmbeddedDocumentExtractor embeddedExtractor)
