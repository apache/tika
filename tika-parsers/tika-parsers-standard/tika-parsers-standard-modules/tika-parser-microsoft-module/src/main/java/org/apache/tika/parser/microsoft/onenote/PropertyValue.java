...
class PropertyValue {
    ...
    public void print(OneNoteDocument document, OneNotePtr pointer, int indentLevel) throws IOException, TikaException {
        ...
        } else if (type == 0x9 || type == 0x8 || type == 0xb || type == 0xc || type == 0xa || type == 0xd) {
    ...
    public String toString() {
        return "PropertyValue{" + "propertyId=" + propertyId + ", scalar=" + scalar + ", compactIDs=" + compactIDs
                + ", propertySet=" + propertySet + ", rawData=" + rawData + '}';
    }
}
