...
public class TestChmLzxcResetTable {
    ...
    public void setUp() throws Exception {
        ...
        chmItspHeader.parse(
                        ChmCommons.copyOfRange(data, (int) chmItsfHeader.getDirOffset(),
                                        (int) chmItsfHeader.getDirOffset()
        ...
        int startIndex = (int) chmDirListCont.getDataOffset() + chmDirListCont
        ...
        dir_chunk = ChmCommons.copyOfRange(data, startIndex, startIndex + chmDirListCont
