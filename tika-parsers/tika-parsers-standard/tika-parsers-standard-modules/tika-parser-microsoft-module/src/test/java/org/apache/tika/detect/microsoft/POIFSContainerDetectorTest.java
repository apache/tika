...
public class POIFSContainerDetectorTest {
    ...
    public void testBasic() throws Exception {
        ...
        String[] expected = new String[] {"application/vnd.ms-excel", "application/msword",
                        "application/vnd.ms-powerpoint", "application/vnd.visio",
    ...
    private void testStream(String fileName, String expectedMime, int markLimit)
                    throws IOException {
    ...
    private void testTikaInputStream(String fileName, String expectedMime, int markLimit)
                    throws IOException {
        String expectedDigest = digest(getStream(fileName));
        POIFSContainerDetector detector = new POIFSContainerDetector();
        detector.setMarkLimit(markLimit);
    ...
    private void assertExpected(Detector detector, InputStream is, String expectedMime,
    ...
    private String digest(String fileName) throws IOException {
        return digest(POIFSContainerDetectorTest.class
