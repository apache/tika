...
/**
 * Parent class of tests that the various POI powered parsers are able to extract their embedded
 * contents.
 */
public abstract class AbstractPOIContainerExtractionTest extends TikaTest {
    ...
    public static final MediaType TYPE_PPTX = MediaType
    ...
    protected static TikaInputStream getTestFile(String filename) throws Exception {
        URL input = AbstractPOIContainerExtractionTest.class
                        .getResource("/test-documents/" + filename);
