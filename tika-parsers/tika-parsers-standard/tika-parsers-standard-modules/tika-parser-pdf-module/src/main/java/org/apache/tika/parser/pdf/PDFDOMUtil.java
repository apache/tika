...
class PDFDOMUtil {
    ...
    /**
     * This recursively looks through cosBase for cosdictionary's that have a type key in the types
     * set. It intentionally does not follow /p, /parent, /page dictionaries.
     *
     * @param cosBase
     * @param types
     * @param maxDepth
