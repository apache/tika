...
/**
 * Checks whether or not a document allows extraction generally or extraction for accessibility
 * only.
 */
public class AccessChecker implements Serializable {
    ...
    /**
     * This constructs an {@link AccessChecker} that will not perform any checking and will always
    ...
    /**
     * This constructs an {@link AccessChecker} that will check for whether or not content should be
     * extracted from a document.
     *
     * @param allowExtractionForAccessibility if general extraction is not allowed, is extraction
     *        for accessibility allowed
     */
    ...
    /**
     * Checks to see if a document's content should be extracted based on metadata values and the
     * value of {@link #allowExtractionForAccessibility} in the constructor.
     *
     * @param metadata
