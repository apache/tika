...
/**
 * Knowns about all declared {@link Metadata} fields. Didn't find this functionality anywhere so it
 * was added for ImageMetadataExtractor, but it can be generalized.
 */
