...
public class ImageParserTest extends TikaTest {
    ...
    public void testGIF() throws Exception {
        ...
        assertEquals(
                "imageLeftPosition=0, imageTopPosition=0, imageWidth=100, " + "imageHeight=75, interlaceFlag=false",
        ...
        assertEquals(
                ...
                metadata.get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "CommentExtensions CommentExtension"));
        assertEquals(
        ...
        assertEquals(
                ...
                metadata.get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "GraphicControlExtension"));
    ...
    public void testJPEG() throws Exception {
        ...
        assertEquals("class=0, htableId=0",
                metadata.get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "markerSequence dht dhtable"));
        assertEquals(
        ...
        assertEquals("elementPrecision=0, qtableId=0",
                metadata.get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "markerSequence dqt dqtable"));
        assertEquals(
        ...
        assertEquals("0.35277778",
                metadata.get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "Dimension HorizontalPixelSize"));
        assertEquals(
                "Licensed to the Apache Software Foundation (ASF) under one or "
        ...
        assertEquals("process=0, samplePrecision=8, numLines=75, samplesPerLine=100, " + "numFrameComponents=3",
    ...
    public void testPNG() throws Exception {
        ...
        assertEquals("deflate",
                metadata.get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "Compression CompressionTypeName"));
        ...
        assertEquals("PixelInterleaved",
                metadata.get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "Data PlanarConfiguration"));
        assertEquals(
