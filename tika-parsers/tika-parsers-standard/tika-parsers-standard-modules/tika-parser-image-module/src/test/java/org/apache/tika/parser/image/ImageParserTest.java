...
public class ImageParserTest extends TikaTest {
    ...
    public void testBMP() throws Exception {
        ...
        assertEquals("1.0", metadata
                        .get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "Dimension PixelAspectRatio"));
        ...
        assertEquals("BI_RGB", metadata.get(
                        ImageMetadataExtractor.UNKNOWN_IMG_NS + "Compression CompressionTypeName"));
    ...
    public void testGIF() throws Exception {
        ...
        assertEquals("true", metadata
                        .get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "Compression Lossless"));
        assertEquals("Normal", metadata
                        .get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "Dimension ImageOrientation"));
        assertEquals("lzw", metadata.get(
                        ImageMetadataExtractor.UNKNOWN_IMG_NS + "Compression CompressionTypeName"));
        assertEquals("0", metadata.get(
                        ImageMetadataExtractor.UNKNOWN_IMG_NS + "Dimension HorizontalPixelOffset"));
        ...
        assertEquals("3",
                        metadata.get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "Chroma NumChannels"));
        assertEquals("1", metadata.get(
                        ImageMetadataExtractor.UNKNOWN_IMG_NS + "Compression NumProgressiveScans"));
        assertEquals("RGB", metadata
                        .get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "Chroma ColorSpaceType"));
        ...
        assertEquals("0", metadata.get(
                        ImageMetadataExtractor.UNKNOWN_IMG_NS + "Dimension VerticalPixelOffset"));
    ...
    public void testJPEG() throws Exception {
        ...
        assertEquals("75", metadata.get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "height"));
        assertEquals("100", metadata.get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "width"));
        assertEquals("0.35277778", metadata.get(
                        ImageMetadataExtractor.UNKNOWN_IMG_NS + "Dimension VerticalPixelSize"));
        assertEquals("false", metadata
                        .get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "Compression Lossless"));
        assertEquals("class=0, htableId=0", metadata
                        .get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "markerSequence dht dhtable"));
        assertEquals("majorVersion=1, minorVersion=1, resUnits=1, Xdensity=72, "
                        + "Ydensity=72, thumbWidth=0, thumbHeight=0",
                        metadata.get(ImageMetadataExtractor.UNKNOWN_IMG_NS
                                        + "JPEGvariety app0JFIF"));
        assertEquals("225", metadata
                        .get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "markerSequence unknown"));
        ...
        assertEquals("1.0", metadata
                        .get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "Dimension PixelAspectRatio"));
        assertEquals("elementPrecision=0, qtableId=0", metadata
                        .get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "markerSequence dqt dqtable"));
        ...
        assertEquals("JPEG", metadata.get(
                        ImageMetadataExtractor.UNKNOWN_IMG_NS + "Compression CompressionTypeName"));
        assertEquals("0.35277778", metadata.get(
                        ImageMetadataExtractor.UNKNOWN_IMG_NS + "Dimension HorizontalPixelSize"));
        assertEquals("Licensed to the Apache Software Foundation (ASF) under one or "
    ...
    public void testPNG() throws Exception {
        ...
        assertEquals("75", metadata.get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "height"));
        assertEquals("100", metadata.get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "width"));
        assertEquals("0.35273367", metadata.get(
                        ImageMetadataExtractor.UNKNOWN_IMG_NS + "Dimension VerticalPixelSize"));
        assertEquals("8 8 8",
                        metadata.get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "Data BitsPerSample"));
        ...
        assertEquals("keyword=Comment, value=Licensed to the Apache Software Foundation "
                        ...
                        + "regarding copyright ownership.",
                        metadata.get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "tEXt tEXtEntry"));
        assertEquals("deflate", metadata.get(
                        ImageMetadataExtractor.UNKNOWN_IMG_NS + "Compression CompressionTypeName"));
        ...
        assertEquals("keyword=Comment, value=Licensed to the Apache Software Foundation "
                        ...
                        metadata.get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "Text TextEntry"));
        assertEquals("PixelInterleaved", metadata
                        .get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "Data PlanarConfiguration"));
        ...
        assertEquals("true",
                        metadata.get(ImageMetadataExtractor.UNKNOWN_IMG_NS + "Chroma BlackIsZero"));
        assertEquals("year=2008, month=5, day=6, hour=6, minute=18, second=47", metadata.get(
                        ImageMetadataExtractor.UNKNOWN_IMG_NS + "Document ImageModificationTime"));
