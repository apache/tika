...
public class ZipSalvager {
    ...
    /**
     * This streams the broken zip and rebuilds a new zip that is at least a valid zip file. The
     * contents of the final stream may be truncated, but the result should be a valid zip file.
     * <p>
