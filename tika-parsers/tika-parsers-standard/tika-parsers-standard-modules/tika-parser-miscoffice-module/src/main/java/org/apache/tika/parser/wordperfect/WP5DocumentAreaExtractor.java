...
/**
 * Extracts WordPerfect Document Area text from a WordPerfect document version 5.x.
 *
...
class WP5DocumentAreaExtractor extends WPDocumentAreaExtractor {
    ...
    /*
     * 192-207 characters represent fixed-length multi-byte functions. Those that are not handled
    ...
    private static final Map<Integer, Integer> FIXED_LENGTH_FUNCTION_SIZES =
                    MapUtils.putAll(new HashMap<>(), new Integer[] {192, 4, // Extended character
