...
/**
 * WordPerfect 5.x constant values used for mapping WordPerfect charsets to unicode equivalents when
 * possible.
 *
...
final class WP5Charsets {
    /**
     * Extended character sets used when fixed-length multi-byte functions with a byte value of 192
     * (0xC0) are found in a WordPerfect document. Those character set codes may be specific to
     * WordPerfect file specifications and may or may not be considered standard outside
     * WordPerfect. Applies to version 5.x.
     */
