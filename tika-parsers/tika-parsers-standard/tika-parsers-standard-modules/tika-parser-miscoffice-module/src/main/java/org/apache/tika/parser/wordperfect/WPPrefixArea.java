...
/**
 * Section of a WordPerfect file called "Prefix Area" containing information about the specific file
 * format/version.
 *
...
class WPPrefixArea {
    ...
    public String toString() {
        return "WP6FileHeader{" + "fileId='" + fileId + '\'' + ", docAreaPointer=" + docAreaPointer
                        + ", productType=" + productType + ", fileType=" + fileType
