...
/**
 * <p>
 * Parser for Corel QuattroPro documents (part of Corel WordPerfect Office Suite). Targets QPW v9
 * File Format but appears to be compatible with more recent versions too.
 * </p>
 *
 * @author Pascal Essiembre
 */
public class QuattroProParser implements Parser {
