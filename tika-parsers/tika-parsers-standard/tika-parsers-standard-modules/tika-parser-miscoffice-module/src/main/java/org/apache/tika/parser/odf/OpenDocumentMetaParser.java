...
public class OpenDocumentMetaParser extends XMLParser {
    ...
    private static ContentHandler getVersion(ContentHandler ch, Metadata md) {
        ...
        ContentHandler branch = new MatchingContentHandler(
                new AttributeMetadataHandler(OFFICE_NS, "version", md, ODF_VERSION_KEY), matcher);
        return new TeeContentHandler(ch, branch);
    }
    ...
    private static ContentHandler getStatistic(ContentHandler ch, Metadata md, String name, String attribute) {
        ...
        ContentHandler branch = new MatchingContentHandler(new AttributeMetadataHandler(META_NS, attribute, md, name),
                matcher);
        return new TeeContentHandler(ch, branch);
    }
    ...
    static ContentHandler getContentHandler(Metadata md, ParseContext context, ContentHandler... handlers) {
        ...
        ContentHandler ch = new TeeContentHandler(getDublinCoreHandler(md, TikaCoreProperties.TITLE, "title"),
        ...
        ch = new TeeContentHandler(ch,
                new ElementMetadataHandler(DublinCore.NAMESPACE_URI_DC, "date", md, TikaCoreProperties.MODIFIED));

        // ODF uses dc:subject for description
        ch = new TeeContentHandler(ch,
                new ElementMetadataHandler(DublinCore.NAMESPACE_URI_DC, "subject", md, OfficeOpenXMLCore.SUBJECT));
    ...
    public void parse(InputStream stream, ContentHandler handler, Metadata metadata, ParseContext context)
        ...
        if (odfSubject != null && !odfSubject.equals("") && (metadata.get(TikaCoreProperties.DESCRIPTION) == null
