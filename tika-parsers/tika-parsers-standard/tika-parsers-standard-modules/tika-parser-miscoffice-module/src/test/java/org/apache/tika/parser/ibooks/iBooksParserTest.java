...
public class iBooksParserTest extends TikaTest {
    ...
    public void testiBooksParser() throws Exception {
        ...
        /*
         * TODO For some reason, the xhtml files in iBooks-style ePub are not parsed properly, and
         * the content comes back empty.git che String content = handler.toString();
         * System.out.println("content="+content); assertContains("Plus a simple div", content);
         * assertContains("First item", content);
         * assertContains("The previous headings were subchapters", content);
         * assertContains("Table data", content); assertContains("Lorem ipsum dolor rutur amet",
         * content);
         */
