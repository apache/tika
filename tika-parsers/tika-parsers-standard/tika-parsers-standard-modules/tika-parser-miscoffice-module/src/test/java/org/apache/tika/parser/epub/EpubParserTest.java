...
public class EpubParserTest extends TikaTest {
    ...
    public void testMultipleMetadataValues() throws Exception {
        ...
        Set<String> contributors = Set.of("The League of Moveable Type", "zikasak",
                        "William Holyoake", "Clare Boothby", "Graeme Mackreth",
                        "Distributed Proofreaders", "Szymon Szott", "David Reimer");
