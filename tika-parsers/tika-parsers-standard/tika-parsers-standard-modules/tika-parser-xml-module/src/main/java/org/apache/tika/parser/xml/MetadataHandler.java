...
/**
 * This adds Metadata entries with a specified name for the textual content of a node (if present),
 * and all attribute values passed through the matcher (but not their names).
 *
 * @deprecated Use the {@link AttributeMetadataHandler} and {@link ElementMetadataHandler} classes
 *             instead
 */
@Deprecated
