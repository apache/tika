...
class AbstractMetadataHandler extends DefaultHandler {
    ...
    /**
     * Adds the given metadata value. The value is ignored if it is <code>null</code> or empty. If
     * the metadata entry already exists, then the given value is appended to it with a comma as the
     * separator.
     *
