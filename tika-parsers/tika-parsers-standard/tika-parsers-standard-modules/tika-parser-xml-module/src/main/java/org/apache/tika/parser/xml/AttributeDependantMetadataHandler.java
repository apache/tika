...
/**
 * This adds a Metadata entry for a given node. The textual content of the node is used as the
 * value, and the Metadata name is taken from an attribute, with a prefix if required.
 */
