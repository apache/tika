 ...
 * value, and the Metadata name is taken from an attribute, keyed under the
...
public class AttributeDependantMetadataHandler extends DefaultHandler {
    ...
    public void addMetadata(String value) {
        ...
        if (value.length() > 0) {
            // a repeated name accumulates as a multi-valued key
            metadata.add(namePrefix, name, value);
        }
    }
